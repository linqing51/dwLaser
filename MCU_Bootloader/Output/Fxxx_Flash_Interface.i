...
#line 1 "FlashEprom\Fxxx_Flash_Interface.c" /0
...
#line 19 "FlashEprom\Fxxx_Flash_Interface.c" /0
 ...
 U8 EE_FLASH_Read (U16);
  ...
  U8 data flashKey1 = 0x00;
  U8 data flashKey2 = 0x00;
  U16 data flashAddress = 0xFFFF;
 ...
 if (flashAddress > 0xF000 + (2*512) - 1)
 {
 flashKey1 = 0x00;                  
 flashKey2 = 0x00;                  
 flashAddress = 0xFFFF;    
 ...
 else if (flashAddress >= 0xF000)
 {
 flashKey1 = 0xA5;                
 
  VDM0CN = 0x80; RSTSRC = (0x02 | 0x02);
 
 pwrite = (S8 xdata *) flashAddress;
 
  
  FLKEY = flashKey1; FLKEY = flashKey2;
 PSCTL |= write_erase;            
 *pwrite = byte;                  
 PSCTL &= ~0x03;                  
 ...
 readPointer = (U8 code *)address;
 for (pageIndex = 0; pageIndex < 512; pageIndex++)
 {
 if (*readPointer != 0xFF)
 {
