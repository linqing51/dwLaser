...
void sPlcPcaRefresh(void){//PCA PWM刷新
	if(NVRAM0[SPREG_AIM0_DUTYRATIO] != NVRAM1[SPREG_AIM0_DUTYRATIO]){
		PCA0CP0 = 0xFFFF - NVRAM0[SPREG_AIM0_DUTYRATIO];
	}
	if(NVRAM0[SPREG_AIM1_DUTYRATIO] != NVRAM1[SPREG_AIM1_DUTYRATIO]){
		PCA0CP1 = 0xFFFF - NVRAM0[SPREG_AIM1_DUTYRATIO];
	}
	if(NVRAM0[SPREG_BEEM_DUTYRATIO] != NVRAM1[SPREG_BEEM_DUTYRATIO]){
		PCA0CP0 = 0xFFFF - NVRAM0[SPREG_BEEM_DUTYRATIO];
	}
}
