...
#error *** WARNING C318 IN LINE 144 OF .\MainApp\appConfig.h: can't open file 'InitDeviceF580.h'
...
#line 1 "Driver\eprom.c" /0
 ...
 iic0SendByte(((0x50 << 1) & 0xFE)); 
 iic0WaitAck();
 iic0SendByte(ReadAddr >> 8); 
 
#line 21 "Driver\eprom.c" /1
 
 
#line 23 "Driver\eprom.c" /0
 iic0WaitAck(); 
 iic0SendByte(ReadAddr % 256);    
 iic0WaitAck();	    
 iic0Start();  	 	   
 iic0SendByte(((0x50 << 1) | 0x01)); 
 iic0WaitAck();	 
 temp = iic0ReadByte(0); 
 iic0Stop();         
 epromBusyFlag = 1;	
...
#line 45 "Driver\eprom.c" /1
 
 
#line 47 "Driver\eprom.c" /0
 iic0WaitAck();	   
