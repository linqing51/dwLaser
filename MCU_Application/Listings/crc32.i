...
#line 4 "Lib\crc32.c" /0
 ...
 uint32_t crc32Calculate(uint8_t *buf, uint32_t idata len){ 
 pdata uint32_t i;  
 for (i = 0; i < len; i++){  
 ...
 uint32_t crc32CalculateAdd(uint8_t idata dat){ 
 ...
 void crc32SetCrcOld(uint32_t  idata old){ 
 oldcrc32 = old;
 }
 
#error *** WARNING C316 IN LINE 129 OF Lib\crc32.c: unterminated conditionals
