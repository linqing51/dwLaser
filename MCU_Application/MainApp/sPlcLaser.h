...
#define EM_LASER_POSWIDTH							(EM_START + 4)//激光正脉宽
#define EM_LASER_NEGWIDTH							(EM_START + 5)//激光负脉宽
#define EM_LASER_GROUP_SPACE						(EM_START + 6)//分组间隔//激光群脉冲间隔
#define EM_LASER_GROUP_NUM							(EM_START + 7)//分组脉冲数//激光群脉冲个数
#define EM_LASER_POWER_CH1							(EM_START + 8)//激光通道1功率设置
#define EM_LASER_POWER_CH2							(EM_START + 9)//激光通道2功率设置
#define EM_LASER_POWER_TOTAL						(EM_START + 10)//激光总功率显示
#define EM_LASER_POWER_RATIO						(EM_START + 11)//激光功率比例显示
#define EM_LASER_RELEASE_ENERY						(EM_START + 13)//激光发射能量显示
#define EM_LASER_RELEASE_TIME						(EM_START + 14)//激光发射时间显示
