	...
	if(NVRAM0[EM_HMI_OPERA_STEP] == FSMSTEP_STANDBY){//待机状态机
		...
		if(LD(R_FAULT)){
			...
			if(LDB(X_INTERLOCK)){//安全连锁拔出
				...
				SetTextValue(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_WARN, LANG_WARN_MSG_DRIVE_HTEMP);
	...
	if(NVRAM0[EM_HMI_OPERA_STEP] == FSMSTEP_LASER_EMITING){//发激光中
		if(LD(SPCOIL_PS1000MS)){
			...
			switch(EM_LASER_PULSE_MODE){
				case LASER_MODE_CW:{
					SetTextInt32(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_RELEASE_TIME ,NVRAM0[EM_RELEASE_TOTAL_TIME], 1, 0);
					SetTextInt32(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_TOTAL_POWER ,NVRAM0[EM_RELEASE_TOTAL_ENERGY], 1, 0);
					break;
				}
				case LASER_MODE_SP:{
					SetTextInt32(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_RELEASE_TIME ,NVRAM0[EM_RELEASE_TOTAL_TIME], 1, 0);
					SetTextInt32(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_TOTAL_POWER ,NVRAM0[EM_RELEASE_TOTAL_ENERGY], 1, 0);
					break;
				}
				case LASER_MODE_MP:{
					SetTextInt32(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_RELEASE_TIME ,NVRAM0[EM_RELEASE_TOTAL_TIME], 1, 0);
					SetTextInt32(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_TOTAL_POWER ,NVRAM0[EM_RELEASE_TOTAL_ENERGY], 1, 0);
					break;
				}
				case LASER_MODE_GP:{
					SetTextInt32(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_RELEASE_TIME ,NVRAM0[EM_RELEASE_TOTAL_TIME], 1, 0);
					SetTextInt32(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_TOTAL_POWER ,NVRAM0[EM_RELEASE_TOTAL_ENERGY], 1, 0);
					break;
				}
				case LASER_MODE_SIGNAL:{
					SetTextInt32(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_RELEASE_TIME ,NVRAM0[EM_RELEASE_TOTAL_TIME], 1, 0);
					SetTextInt32(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_TOTAL_POWER ,NVRAM0[EM_RELEASE_TOTAL_ENERGY], 1, 0);
					break;
				}
				case LASER_MODE_DERMA:{
					SetTextInt32(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_RELEASE_TIME ,NVRAM0[EM_RELEASE_TOTAL_TIME], 1, 0);
					SetTextInt32(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_TOTAL_POWER ,NVRAM0[EM_RELEASE_TOTAL_ENERGY], 1, 0);
					break;
				}
				default:break;
			}
