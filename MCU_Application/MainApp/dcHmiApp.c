...
static void updateStandbyDisplay(void){//更新方案显示
	...
	switch(NVRAM0[EM_LASER_PULSE_MODE]){
		case LASER_MODE_CW:{
			...
			sprintf(dispBuf, "%8.1fW", (LaserReleaseEnergy / 10000));
			SetTextValue(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_ENERGY, dispBuf);
			sprintf(dispBuf, "%8.1fW", (LaserReleaseTime / 1000));
			SetTextValue(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_RELEASE_TIME, dispBuf);
		...
		case LASER_MODE_SP:{
			...
			sprintf(dispBuf, "%8.1fW", (LaserReleaseEnergy / 10000));
			SetTextValue(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_ENERGY, dispBuf);
			sprintf(dispBuf, "%8.1fW", (LaserReleaseTime / 1000));
			SetTextValue(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_RELEASE_TIME, dispBuf);			
		...
		case LASER_MODE_MP:{
			...
			sprintf(dispBuf, "%8.1fW", (LaserReleaseEnergy / 10000));
			SetTextValue(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_ENERGY, dispBuf);
			sprintf(dispBuf, "%8.1fW", (LaserReleaseTime / 1000));
			SetTextValue(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_RELEASE_TIME, dispBuf);				
		...
		case LASER_MODE_GP:{
			...
			sprintf(dispBuf, "%8.1fW", (LaserReleaseEnergy / 10000));
			SetTextValue(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_ENERGY, dispBuf);
			sprintf(dispBuf, "%8.1fW", (LaserReleaseTime / 1000));
			SetTextValue(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_RELEASE_TIME, dispBuf);
		...
		case LASER_MODE_DERMA:{
			...
			sprintf(dispBuf, "%8.1fW", (LaserReleaseEnergy / 10000));
			SetTextValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_ENERGY, dispBuf);
			sprintf(dispBuf, "%8.1fW", (LaserReleaseTime / 1000));
			SetTextValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_RELEASE_TIME, dispBuf);
		...
		case LASER_MODE_SIGNAL:{
			...
			sprintf(dispBuf, "%8.1fW", (LaserReleaseEnergy / 10000));
			SetTextValue(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_ENERGY, dispBuf);
			sprintf(dispBuf, "%8.1fW", (LaserReleaseTime / 1000));
			SetTextValue(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_RELEASE_TIME, dispBuf);			
			SetProgressValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_PROGRESS_CH0, ((uint32_t)NVRAM0[EM_LASER_POWER_CH0] * 100 / CONFIG_MAX_LASERPOWER_CH0));
			SetProgressValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_PROGRESS_CH1, ((uint32_t)NVRAM0[EM_LASER_POWER_CH1] * 100 / CONFIG_MAX_LASERPOWER_CH1));
			SetTextValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_NAME, (char*)(&NVRAM0[EM_LASER_SCHEME_NAME]));		
			SetTextFloat(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_ENERGY, (LaserReleaseEnergy / 10000), 1 , 1);
			...
			sprintf(dispBuf, "%dJ",  NVRAM0[EM_LASER_SIGNAL_ENERGY_INTERVAL]);			
			SetTextValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_ENERGY_INTERVAL, dispBuf);	
				...
				if(LD(R_STANDBY_KEY_ENERGY_INTERVAL_ADD_DOWN)){//能量间隔加按键
					...
					if(LD(T_10MS_START * 16 + T10MS_ENERGY_INTERVAL_ADD_KEYDOWN_DELAY)){	
						if(LDP(SPCOIL_PS10MS) && (NVRAM0[EM_LASER_SIGNAL_ENERGY_INTERVAL] < CONFIG_MAX_LASER_ENERGY_INTERVAL)){
							...
							sprintf(dispBuf, "%dJ", (NVRAM0[EM_LASER_SIGNAL_ENERGY_INTERVAL] * CONFIG_LASER_ENERGY_INTERVAL));			
							SetTextValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_ENERGY_INTERVAL, dispBuf);		
						}
					}
				}
