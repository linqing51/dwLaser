...
static void updateStandbyDisplay(void){//更新方案显示
	...
	switch(NVRAM0[EM_LASER_PULSE_MODE]){
		...
		case LASER_MODE_SP:{
			...
			SetTextFloat(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_TOTAL_POWER, ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 10), 1 , 1);
		...
		case LASER_MODE_DERMA:{
			...
			switch(NVRAM0[EM_LASER_DERMA_SPOT_SIZE]){
				case DERMA_SPOT_SIZE_0MM5:{
					...
					SetTextFloat(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_ENERGY_DENSITY, ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 0.0019625), 1 , 1);
					break;
				}
				case DERMA_SPOT_SIZE_1MM0:{
					...
					SetButtonValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_2MM0, 0x00);
					SetButtonValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_3MM0, 0x00);
					SetTextFloat(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_ENERGY_DENSITY, ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 0.00785), 1 , 1);
					break;
				}
				case DERMA_SPOT_SIZE_2MM0:{
					...
					SetButtonValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_3MM0, 0x00);
					SetTextFloat(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_ENERGY_DENSITY, ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 0.0314926), 1 , 1);
					break;
				}
				case DERMA_SPOT_SIZE_3MM0:{
					...
					SetTextFloat(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_ENERGY_DENSITY, ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 0.0706853), 1 , 1);
					break;
				}
				default:break;
			}
...
static void updateOptionDisplay(void){//更新选项显示
	...
	switch(NVRAM0[DM_LANGUAGE]){
		case DEF_LANG_EN:{
			SetButtonValue(GDDC_PAGE_OPTION_0, GDDC_PAGE_OPTION_KEY_LANGUAGE_EN, 0x01);
			SetButtonValue(GDDC_PAGE_OPTION_0, GDDC_PAGE_OPTION_KEY_LANGUAGE_CN, 0x00);
			break;
		}
		case DEF_LANG_CN:{
			SetButtonValue(GDDC_PAGE_OPTION_0, GDDC_PAGE_OPTION_KEY_LANGUAGE_EN, 0x00);
			SetButtonValue(GDDC_PAGE_OPTION_0, GDDC_PAGE_OPTION_KEY_LANGUAGE_CN, 0x01);
			break;
		}
		case DEF_LANG_JP:{
			break;
