...
void UpdateUI(void);
static void updataNegWidthDisplay(void);
...
void updateSchemeDisplay(void){//更新选项界面方案名称
	...
	SetTextValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_0, dispBuf);
	
	memcpy(dispBuf, (char*)(&FDRAM[FD_SCHEME_START_1]), 30);
	SetTextValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_1, dispBuf);
	
	memcpy(dispBuf, (char*)(&FDRAM[FD_SCHEME_START_2]), 30);
	SetTextValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_2, dispBuf);

	memcpy(dispBuf, (char*)(&FDRAM[FD_SCHEME_START_3]), 30);
	SetTextValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_3, dispBuf);
	
	memcpy(dispBuf, (char*)(&FDRAM[FD_SCHEME_START_4]), 30);
	SetTextValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_4, dispBuf);
	
	memcpy(dispBuf, (char*)(&FDRAM[FD_SCHEME_START_5]), 30);
	SetTextValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_5, dispBuf);
	
	memcpy(dispBuf, (char*)(&FDRAM[FD_SCHEME_START_6]), 30);
	SetTextValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_6, dispBuf);

	memcpy(dispBuf, (char*)(&FDRAM[FD_SCHEME_START_7]), 30);
	SetTextValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_7, dispBuf);
	
	memcpy(dispBuf, (char*)(&FDRAM[FD_SCHEME_START_8]), 30);
	SetTextValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_8, dispBuf);
	
	memcpy(dispBuf, (char*)(&FDRAM[FD_SCHEME_START_9]), 30);
	SetTextValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_9, dispBuf);
	
	memcpy(dispBuf, (char*)(&FDRAM[FD_SCHEME_START_10]), 30);
	SetTextValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_10, dispBuf);

	memcpy(dispBuf, (char*)(&FDRAM[FD_SCHEME_START_11]), 30);
	SetTextValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_11, dispBuf);
	
	memcpy(dispBuf, (char*)(&FDRAM[FD_SCHEME_START_12]), 30);
	SetTextValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_12, dispBuf);
	
	memcpy(dispBuf, (char*)(&FDRAM[FD_SCHEME_START_13]), 30);
	SetTextValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_13, dispBuf);
	
	memcpy(dispBuf, (char*)(&FDRAM[FD_SCHEME_START_14]), 30);
	SetTextValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_14, dispBuf);
...
void updateReleaseTimeEnergy(void){//刷新发射时间能量
	SetTextInt32(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_RELEASE_TIME ,NVRAM0[EM_RELEASE_TOTAL_TIME], 1, 0);
	SetTextInt32(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_ENERGY ,NVRAM0[EM_RELEASE_TOTAL_ENERGY], 1, 0);

	SetTextInt32(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_RELEASE_TIME ,NVRAM0[EM_RELEASE_TOTAL_TIME], 1, 0);
	SetTextInt32(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_ENERGY ,NVRAM0[EM_RELEASE_TOTAL_ENERGY], 1, 0);

	SetTextInt32(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_RELEASE_TIME ,NVRAM0[EM_RELEASE_TOTAL_TIME], 1, 0);
	SetTextInt32(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_ENERGY ,NVRAM0[EM_RELEASE_TOTAL_ENERGY], 1, 0);

	SetTextInt32(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_RELEASE_TIME ,NVRAM0[EM_RELEASE_TOTAL_TIME], 1, 0);
	SetTextInt32(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_ENERGY ,NVRAM0[EM_RELEASE_TOTAL_ENERGY], 1, 0);

	SetTextInt32(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_RELEASE_TIME ,NVRAM0[EM_RELEASE_TOTAL_TIME], 1, 0);
	SetTextInt32(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_ENERGY ,NVRAM0[EM_RELEASE_TOTAL_ENERGY], 1, 0);

	SetTextInt32(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_RELEASE_TIME ,NVRAM0[EM_RELEASE_TOTAL_TIME], 1, 0);
	SetTextInt32(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_ENERGY ,NVRAM0[EM_RELEASE_TOTAL_ENERGY], 1, 0);
}
void updateWarnMsgDisplay(uint8_t id){//更新警号显示框
	...
	if(MsgId != id){
		...
		SetTextValue(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_WARN, pstr);
		SetTextValue(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_WARN, pstr);
		SetTextValue(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_WARN, pstr);
		SetTextValue(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_WARN, pstr);
		SetTextValue(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_WARN, pstr);
		SetTextValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_WARN, pstr);
		MsgId = id;
	}
}
void unselectSchemeNum(sel){//反选方案条
	switch(sel){
		case 0:{
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_0 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_0, 0x0);
			break;
		}
		case 1:{
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_1 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_1, 0x0);
			break;
		}
		case 2:{
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_2 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_2, 0x0);
			break;
		}
		case 3:{
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_3 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_3, 0x0);
			break;
		}
		case 4:{
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_4 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_4, 0x0);
			break;
		}
		case 5:{
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_5 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_5, 0x0);
			break;
		}
		case 6:{
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_6 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_6, 0x0);
			break;
		}
		case 7:{
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_7 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_7, 0x0);
			break;
		}
		case 8:{
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_8 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_8, 0x0);
			break;
		}
		case 9:{
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_9 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_9, 0x0);
			break;
		}
		case 10:{
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_10 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_10, 0x0);
			break;
		}
		case 11:{
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_11 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_11, 0x0);
			break;
		}
		case 12:{
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_12 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_12, 0x0);
			break;
		}
		case 13:{
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_13 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_13, 0x0);
			break;
		}
		case 14:{
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_14 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_14, 0x0);
			break;
		}
		case 15:{
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_15 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_15, 0x0);
			break;
		}
		default:break;
	}
...
void seletcSchemeNum(uint16_t sel){
	switch(sel){
		case 0:{
			...
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_0 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_0, 0x1);
			NVRAM0[EM_SCHEME_NUM_TMP] = 0;
			break;
		}
		case 1:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_1 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_1, 0x1);		
			NVRAM0[EM_SCHEME_NUM_TMP] = 1;
			break;
		}
		case 2:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_2 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_2, 0x1);
			NVRAM0[EM_SCHEME_NUM_TMP] = 2;
			break;
		}
		case 3:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_3 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_3, 0x1);
			NVRAM0[EM_SCHEME_NUM_TMP] = 3;
			break;
		}
		case 4:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_4 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_4, 0x1);
			NVRAM0[EM_SCHEME_NUM_TMP] = 4;
			break;
		}
		case 5:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_5 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_5, 0x1);
			NVRAM0[EM_SCHEME_NUM_TMP] = 5;
			break;
		}
		case 6:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_6 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_6, 0x1);
			NVRAM0[EM_SCHEME_NUM_TMP] = 6;
			break;
		}
		case 7:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_7 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_7, 0x1);
			NVRAM0[EM_SCHEME_NUM_TMP] = 7;
			break;
		}
		case 8:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_8 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_8, 0x1);
			NVRAM0[EM_SCHEME_NUM_TMP] = 8;
			break;
		}
		case 9:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_9 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_9, 0x1);	
			NVRAM0[EM_SCHEME_NUM_TMP] = 9;
			break;
		}
		case 10:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_10 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_10, 0x1);
			NVRAM0[EM_SCHEME_NUM_TMP] = 10;
			break;
		}
		case 11:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_11 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_11, 0x1);	
			NVRAM0[EM_SCHEME_NUM_TMP] = 11;
			break;
		}
		case 12:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_12 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_12, 0x1);	
			NVRAM0[EM_SCHEME_NUM_TMP] = 12;
			break;
		}
		case 13:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_13 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_13, 0x1);
			NVRAM0[EM_SCHEME_NUM_TMP] = 13;
			break;
		}
		case 14:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_14 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_14, 0x1);
			NVRAM0[EM_SCHEME_NUM_TMP] = 14;
			break;
		}
		case 15:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlForeColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_15 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SELECT_15, 0x1);
	...
	switch(mode){
		case LASER_MODE_CW:{
			switch(ch){
				case LASER_SELECT_CH0:{
					...
					SetTextValue(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_POWER_CH0, dispBuf);
					sprintf(dispBuf, "%4.1f W", ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 10));
					SetTextValue(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_TOTAL_POWER, dispBuf);
					break;
				}
				case LASER_SELECT_CH1:{
					sprintf(dispBuf, "%4.1f W", ((fp32_t)(NVRAM0[EM_LASER_POWER_CH1]) / 10));
					SetTextValue(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_POWER_CH1, dispBuf);
					sprintf(dispBuf, "%4.1f W", ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 10));
					SetTextValue(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_TOTAL_POWER, dispBuf);
					break;
				}
		...
		case LASER_MODE_SP:{
			switch(ch){
				case LASER_SELECT_CH0:{
					sprintf(dispBuf, "%4.1f W", ((fp32_t)(NVRAM0[EM_LASER_POWER_CH0]) / 10));
					SetTextValue(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_POWER_CH0, dispBuf);
					sprintf(dispBuf, "%4.1f W", ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 10));
					SetTextValue(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_TOTAL_POWER, dispBuf);
					break;
				}
				case LASER_SELECT_CH1:{
					sprintf(dispBuf, "%4.1f W", ((fp32_t)(NVRAM0[EM_LASER_POWER_CH1]) / 10));
					SetTextValue(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_POWER_CH1, dispBuf);
					sprintf(dispBuf, "%4.1f W", ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 10));
					SetTextValue(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_TOTAL_POWER, dispBuf);
					break;
				}
		...
		case LASER_MODE_GP:{
			switch(ch){
				case LASER_SELECT_CH0:{
					sprintf(dispBuf, "%4.1f W", ((fp32_t)(NVRAM0[EM_LASER_POWER_CH0]) / 10));
					SetTextValue(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_POWER_CH0, dispBuf);
					sprintf(dispBuf, "%4.1f W", ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 10));
					SetTextValue(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_TOTAL_POWER, dispBuf);
					break;
				}
				case LASER_SELECT_CH1:{
					sprintf(dispBuf, "%4.1f W", ((fp32_t)(NVRAM0[EM_LASER_POWER_CH1]) / 10));
					SetTextValue(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_POWER_CH1, dispBuf);
					sprintf(dispBuf, "%4.1f W", ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 10));
					SetTextValue(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_TOTAL_POWER, dispBuf);
					break;
				}
		...
		case LASER_MODE_DERMA:{
			switch(ch){
				case LASER_SELECT_CH0:{
					sprintf(dispBuf, "%4.1f W", ((fp32_t)(NVRAM0[EM_LASER_POWER_CH0]) / 10));
					SetTextValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_POWER_CH0, dispBuf);
					sprintf(dispBuf, "%4.1f W", ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 10));
					SetTextValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_TOTAL_POWER, dispBuf);
					break;
				}
				case LASER_SELECT_CH1:{
					sprintf(dispBuf, "%4.1f W", ((fp32_t)(NVRAM0[EM_LASER_POWER_CH1]) / 10));
					SetTextValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_POWER_CH1, dispBuf);
					sprintf(dispBuf, "%4.1f W", ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 10));
					SetTextValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_TOTAL_POWER, dispBuf);
					break;
				}
		...
		case LASER_MODE_SIGNAL:{
			switch(ch){
				case LASER_SELECT_CH0:{
					sprintf(dispBuf, "%4.1f W", ((fp32_t)(NVRAM0[EM_LASER_POWER_CH0]) / 10));
					SetTextValue(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_POWER_CH0, dispBuf);
					sprintf(dispBuf, "%4.1f W", ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 10));
					SetTextValue(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_TOTAL_POWER, dispBuf);
					break;
				}
				case LASER_SELECT_CH1:{
					sprintf(dispBuf, "%4.1f W", ((fp32_t)(NVRAM0[EM_LASER_POWER_CH1]) / 10));
					SetTextValue(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_POWER_CH1, dispBuf);
					sprintf(dispBuf, "%4.1f W", ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 10));
					SetTextValue(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_TOTAL_POWER, dispBuf);
					break;
				}
...
void updateStandbyDisplay(void){//更新方案显示
	...
	switch(NVRAM0[EM_LASER_PULSE_MODE]){
		case LASER_MODE_CW:{
			...
			SetProgressValue(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_PROGRESS_CH0, ((uint32_t)NVRAM0[EM_LASER_POWER_CH0] * 100 / CONFIG_MAX_LASERPOWER_CH0));
			SetProgressValue(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_PROGRESS_CH1, ((uint32_t)NVRAM0[EM_LASER_POWER_CH1] * 100 / CONFIG_MAX_LASERPOWER_CH1));
			SetTextValue(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_NAME, (char*)(&NVRAM0[EM_LASER_SCHEME_NAME]));
			
			BatchBegin(GDDC_PAGE_STANDBY_CW_0);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_CW, 0x01);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_SP, 0x00);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_MP, 0x00);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_GP, 0x00);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_SIGNAL, 0x00);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_DERMA, 0x00);
			BatchEnd();
		...
		case LASER_MODE_SP:{
			...
			BatchBegin(GDDC_PAGE_STANDBY_SP_0);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_CW, 0x00);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_SP, 0x01);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_MP, 0x00);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_GP, 0x00);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_SIGNAL, 0x00);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_DERMA, 0x00);
		...
		case LASER_MODE_MP:{
			...
			SetProgressValue(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_PROGRESS_CH0, ((uint32_t)NVRAM0[EM_LASER_POWER_CH0] * 100 / CONFIG_MAX_LASERPOWER_CH0));
			SetProgressValue(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_PROGRESS_CH1, ((uint32_t)NVRAM0[EM_LASER_POWER_CH1] * 100 / CONFIG_MAX_LASERPOWER_CH1));
			SetTextValue(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_NAME, (char*)(&NVRAM0[EM_LASER_SCHEME_NAME]));			
			
			BatchBegin(GDDC_PAGE_STANDBY_MP_0);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_CW, 0x00);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_SP, 0x00);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_MP, 0x01);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_GP, 0x00);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_SIGNAL, 0x00);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_DERMA, 0x00);
			BatchEnd();
		...
		case LASER_MODE_GP:{
			...
			SetProgressValue(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_PROGRESS_CH0, ((uint32_t)NVRAM0[EM_LASER_POWER_CH0] * 100 / CONFIG_MAX_LASERPOWER_CH0));
			SetProgressValue(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_PROGRESS_CH1, ((uint32_t)NVRAM0[EM_LASER_POWER_CH1] * 100 / CONFIG_MAX_LASERPOWER_CH1));
			SetTextValue(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_NAME, (char*)(&NVRAM0[EM_LASER_SCHEME_NAME]));			
			
			BatchBegin(GDDC_PAGE_STANDBY_GP_0);	
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_CW, 0x00);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_SP, 0x00);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_MP, 0x00);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_GP, 0x01);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_SIGNAL, 0x00);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_DERMA, 0x00);		
			BatchEnd();
		...
		case LASER_MODE_DERMA:{
			...
			SetProgressValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_PROGRESS_CH0, ((uint32_t)NVRAM0[EM_LASER_POWER_CH0] * 100 / CONFIG_MAX_LASERPOWER_CH0));
			SetProgressValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_PROGRESS_CH1, ((uint32_t)NVRAM0[EM_LASER_POWER_CH1] * 100 / CONFIG_MAX_LASERPOWER_CH1));
			SetTextValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_NAME, (char*)(&NVRAM0[EM_LASER_SCHEME_NAME]));				
			...
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_GP, 0x00);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_SIGNAL, 0x00);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_DERMA, 0x01);		
			BatchEnd();
		...
		case LASER_MODE_SIGNAL:{
			...
			SetProgressValue(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_PROGRESS_CH0, ((uint32_t)NVRAM0[EM_LASER_POWER_CH0] * 100 / CONFIG_MAX_LASERPOWER_CH0));
			SetProgressValue(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_PROGRESS_CH1, ((uint32_t)NVRAM0[EM_LASER_POWER_CH1] * 100 / CONFIG_MAX_LASERPOWER_CH1));
			SetTextValue(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_TEXTDISPLAY_NAME, (char*)(&NVRAM0[EM_LASER_SCHEME_NAME]));			
			...
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_MP, 0x00);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_GP, 0x00);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_SIGNAL, 0x01);
			BatchSetButtonValue(GDDC_PAGE_STANDBY_KEY_MODE_DERMA, 0x00);
			BatchEnd();
...
void standbyKeyEnable(uint8_t ena){//Standby使能
	if(StandbyEnableState != ena){
		...
		SetControlEnable(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_KEY_STANDBY, ena);
		SetControlEnable(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_KEY_STANDBY, ena);
		SetControlEnable(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_KEY_STANDBY, ena);
		SetControlEnable(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_KEY_STANDBY, ena);
		SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_KEY_STANDBY, ena);
		SetControlEnable(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_KEY_STANDBY, ena);
	}
}
void standbyKeyValue(uint8_t value){//Standby键值
	SetButtonValue(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_KEY_STANDBY, value);
	SetButtonValue(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_KEY_STANDBY, value);
	SetButtonValue(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_KEY_STANDBY, value);
	SetButtonValue(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_KEY_STANDBY, value);
	SetButtonValue(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_KEY_STANDBY, value);
	SetButtonValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_KEY_STANDBY, value);
}
