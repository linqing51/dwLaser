...
static void checkScheme(void){//方案合规检测
	...
	for(index = 0;index < CONFIG_HMI_SCHEME_NUM;index ++){
		...
		//SP
		if(NVRAM0[(DM_LASER_SP_POSWIDTH + (index * 30))] > CONFIG_MAX_LASER_POSWIDTH){
			NVRAM0[(DM_LASER_SP_POSWIDTH + (index * 30))] = CONFIG_MAX_LASER_POSWIDTH;
		}
		if(NVRAM0[(DM_LASER_SP_POSWIDTH + (index * 30))] < CONFIG_MIN_LASER_POSWIDTH){
			NVRAM0[(DM_LASER_SP_POSWIDTH + (index * 30))] = CONFIG_MIN_LASER_POSWIDTH;
		}
		//MP
		if(NVRAM0[(DM_LASER_MP_POSWIDTH + (index * 30))] > CONFIG_MAX_LASER_POSWIDTH){
			NVRAM0[(DM_LASER_MP_POSWIDTH + (index * 30))] = CONFIG_MAX_LASER_POSWIDTH;
		}
		if(NVRAM0[(DM_LASER_MP_POSWIDTH + (index * 30))] < CONFIG_MIN_LASER_POSWIDTH){
			NVRAM0[(DM_LASER_MP_POSWIDTH + (index * 30))] = CONFIG_MIN_LASER_POSWIDTH;
		}
		if(NVRAM0[(DM_LASER_MP_NEGWIDTH + (index * 30))] > CONFIG_MAX_LASER_NEGWIDTH){
			NVRAM0[(DM_LASER_MP_NEGWIDTH + (index * 30))] = CONFIG_MAX_LASER_NEGWIDTH;
		}
		if(NVRAM0[(DM_LASER_MP_NEGWIDTH + (index * 30))] < CONFIG_MIN_LASER_NEGWIDTH){
			NVRAM0[(DM_LASER_MP_NEGWIDTH + (index * 30))] = CONFIG_MIN_LASER_NEGWIDTH;
		}
		//GP
		if(NVRAM0[(DM_LASER_GP_POSWIDTH + (index * 30))] > CONFIG_MAX_LASER_POSWIDTH){
			NVRAM0[(DM_LASER_GP_POSWIDTH + (index * 30))] = CONFIG_MAX_LASER_POSWIDTH;
		}
		if(NVRAM0[(DM_LASER_GP_POSWIDTH + (index * 30))] < CONFIG_MIN_LASER_NEGWIDTH){
			NVRAM0[(DM_LASER_GP_POSWIDTH + (index * 30))] = CONFIG_MIN_LASER_NEGWIDTH;
		}
		if(NVRAM0[(DM_LASER_GP_NEGWIDTH + (index * 30))] > CONFIG_MAX_LASER_NEGWIDTH){
			NVRAM0[(DM_LASER_GP_NEGWIDTH + (index * 30))] = CONFIG_MAX_LASER_NEGWIDTH;
		}
		if(NVRAM0[(DM_LASER_GP_NEGWIDTH + (index * 30))] < CONFIG_MIN_LASER_NEGWIDTH){
			NVRAM0[(DM_LASER_GP_NEGWIDTH + (index * 30))] = CONFIG_MIN_LASER_NEGWIDTH;
		}
		if(NVRAM0[(DM_LASER_GP_TIMES + (index * 30))] > CONFIG_MAX_LASER_TIMES){
			NVRAM0[(DM_LASER_GP_TIMES + (index * 30))] = CONFIG_MAX_LASER_TIMES;
		}
		if(NVRAM0[(DM_LASER_GP_TIMES + (index * 30))] < CONFIG_MIN_LASER_TIMES){
			NVRAM0[(DM_LASER_GP_TIMES + (index * 30))] = CONFIG_MIN_LASER_TIMES;
		}
		if(NVRAM0[(DM_LASER_GP_GROUP_OFF + (index * 30))] > CONFIG_MAX_LASER_GROUP_OFF){
			NVRAM0[(DM_LASER_GP_GROUP_OFF + (index * 30))] = CONFIG_MAX_LASER_GROUP_OFF;
		}
		if(NVRAM0[(DM_LASER_GP_GROUP_OFF + (index * 30))] < CONFIG_MIN_LASER_GROUP_OFF){
			NVRAM0[(DM_LASER_GP_GROUP_OFF + (index * 30))] = CONFIG_MIN_LASER_GROUP_OFF;
		}
		//SIGNAL
		if(NVRAM0[DM_LASER_SIGNAL_ENERGY_INTERVAL + index * 30] > CONFIG_MAX_LASER_ENERGY_INTERVAL){
			NVRAM0[DM_LASER_SIGNAL_ENERGY_INTERVAL + index * 30] = CONFIG_MAX_LASER_ENERGY_INTERVAL;
		}
		if(NVRAM0[DM_LASER_SIGNAL_ENERGY_INTERVAL + index * 30] < CONFIG_MIN_LASER_ENERGY_INTERVAL){
			NVRAM0[DM_LASER_SIGNAL_ENERGY_INTERVAL + index * 30] = CONFIG_MIN_LASER_ENERGY_INTERVAL;
		}
		//DERMA
		if(NVRAM0[(DM_LASER_DERMA_POSWIDTH + (index * 30))] > CONFIG_MAX_LASER_POSWIDTH){
			NVRAM0[(DM_LASER_DERMA_POSWIDTH + (index * 30))] = CONFIG_MAX_LASER_POSWIDTH;
		}
		if(NVRAM0[(DM_LASER_DERMA_POSWIDTH + (index * 30))] < CONFIG_MIN_LASER_NEGWIDTH){
			NVRAM0[(DM_LASER_DERMA_POSWIDTH + (index * 30))] = CONFIG_MIN_LASER_NEGWIDTH;
		}
		if(NVRAM0[(DM_LASER_DERMA_NEGWIDTH + (index * 30))] > CONFIG_MAX_LASER_NEGWIDTH){
			NVRAM0[(DM_LASER_DERMA_NEGWIDTH + (index * 30))] = CONFIG_MAX_LASER_NEGWIDTH;
		}
		if(NVRAM0[(DM_LASER_DERMA_NEGWIDTH + (index * 30))] < CONFIG_MIN_LASER_NEGWIDTH){
			NVRAM0[(DM_LASER_DERMA_NEGWIDTH + (index * 30))] = CONFIG_MIN_LASER_NEGWIDTH;
		}
		if((NVRAM0[DM_LASER_DERMA_SPOT_SIZE + index * 30] != DERMA_SPOT_SIZE_0MM5) &&
		  (NVRAM0[DM_LASER_DERMA_SPOT_SIZE + index * 30] != DERMA_SPOT_SIZE_1MM0) &&
		  (NVRAM0[DM_LASER_DERMA_SPOT_SIZE + index * 30] != DERMA_SPOT_SIZE_2MM0) &&
		  (NVRAM0[DM_LASER_DERMA_SPOT_SIZE + index * 30] != DERMA_SPOT_SIZE_3MM0)){
			NVRAM0[DM_LASER_DERMA_SPOT_SIZE + index * 30] = DERMA_SPOT_SIZE_0MM5;	
		}
	}
}
...
//	SetTextValue(GDDC_PAGE_SCHEME_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_FULLNAME, (char*)(&NVRAM0[(DM_LASER_SCHEME_NAME + (NVRAM0[EM_SCHEME_NUM_TMP] * 25))]));
//	SetTextFloat(GDDC_PAGE_SCHEME_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_POWER_CH0, ((fp32_t)(NVRAM0[(DM_LASER_POWER_CH0 + (NVRAM0[EM_SCHEME_NUM_TMP] * 25))]) / 10), 1 , 1);
//	SetTextFloat(GDDC_PAGE_SCHEME_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_POWER_CH1, ((fp32_t)(NVRAM0[(DM_LASER_POWER_CH1 + (NVRAM0[EM_SCHEME_NUM_TMP] * 25))]) / 10), 1 , 1);
//	
//	SetTextInt32(GDDC_PAGE_SCHEME_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_POSWIDTH ,NVRAM0[(DM_LASER_POSWIDTH + (NVRAM0[EM_SCHEME_NUM_TMP] * 25))], 1, 0);
//	SetTextInt32(GDDC_PAGE_SCHEME_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_NEGWIDTH ,NVRAM0[(DM_LASER_NEGWIDTH + (NVRAM0[EM_SCHEME_NUM_TMP] * 25))], 1, 0);
//	SetTextInt32(GDDC_PAGE_SCHEME_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_TIMES ,NVRAM0[(DM_LASER_TIMES + (NVRAM0[EM_SCHEME_NUM_TMP] * 25))], 1, 0);
//	SetTextInt32(GDDC_PAGE_SCHEME_0, GDDC_PAGE_SCHEME_TEXTDISPALY_GROUP_OFF ,NVRAM0[(DM_LASER_GROUP_OFF + (NVRAM0[EM_SCHEME_NUM_TMP] * 25))], 1, 0);
}
static void standbyTouchEnable(int8_t enable){//
	switch(NVRAM0[EM_LASER_PULSE_MODE]){
		case LASER_MODE_CW:{
			...
			if(enable){
				SetButtonValue(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_CW_KEY_STANDBY, 0);
			}
			else{
				SetButtonValue(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_CW_KEY_STANDBY, 1);
			}
			break;
		}
		case LASER_MODE_SP:{
			...
			if(enable){
				SetButtonValue(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_SP_KEY_STANDBY, 1);
			}
			else{
				SetButtonValue(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_SP_KEY_STANDBY, 0);
			}
		...
		case LASER_MODE_MP:{
			...
			if(enable){
				SetButtonValue(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_MP_KEY_STANDBY, 0);
			}
			else{
				SetButtonValue(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_MP_KEY_STANDBY, 1);
			}
			break;
		}
		case LASER_MODE_GP:{
			...
			if(enable){
				SetButtonValue(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_GP_KEY_STANDBY, 0);
			}
			else{
				SetButtonValue(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_GP_KEY_STANDBY, 1);
			}
			break;
		}
		case LASER_MODE_DERMA:{
			...
			if(enable){
				SetButtonValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_KEY_STANDBY, 0);
			}
			else{
				SetButtonValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_KEY_STANDBY, 1);
			}
			break;
		}
		case LASER_MODE_SIGNAL:{
			...
			if(enable){
				SetButtonValue(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_SIGNAL_KEY_STANDBY, 0);
			}
			else{
				SetButtonValue(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_SIGNAL_KEY_STANDBY, 1);
			}
			break;
		}
		default:break;
...
static void updateStandbyDisplay(void){//更新方案显示
	switch(NVRAM0[EM_LASER_PULSE_MODE]){
		fp32_t ftemp;
		ftemp = (NVRAM0[EM_LASER_POWER_CH0] + NVRAM0[EM_LASER_POWER_CH1]) / 10.0F; 
		case LASER_MODE_CW:{
			NVRAM0[EM_DC_PAGE] = GDDC_PAGE_STANDBY_CW_0;//切换待机页面			
			SetTextFloat(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_POWER_CH0, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH0]) / 10), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_POWER_CH1, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH1]) / 10), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_TOTAL_POWER, ftemp, 1 , 1);
			...
			SetTextFloat(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_ENERGY, (LaserReleaseEnergy / 10000), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_RELEASE_TIME, (LaserReleaseTime / 1000), 1 , 1);
		...
		case LASER_MODE_SP:{
			...
			SetTextFloat(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_POWER_CH0, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH0]) / 10), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_POWER_CH1, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH1]) / 10), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_TOTAL_POWER, ftemp, 1 , 1);
			...
			SetTextFloat(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_ENERGY, (LaserReleaseEnergy / 10000), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_RELEASE_TIME, (LaserReleaseTime / 1000), 1 , 1);		
		...
		case LASER_MODE_MP:{
			...
			SetTextFloat(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_POWER_CH0, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH0]) / 10), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_POWER_CH1, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH1]) / 10), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_TOTAL_POWER, ftemp, 1 , 1);
			...
			SetTextFloat(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_ENERGY, (LaserReleaseEnergy / 10000), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_RELEASE_TIME, (LaserReleaseTime / 1000), 1 , 1);		
		...
		case LASER_MODE_GP:{
			...
			SetTextFloat(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_POWER_CH0, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH0]) / 10), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_POWER_CH1, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH1]) / 10), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_TOTAL_POWER, ftemp, 1 , 1);
			...
			SetTextFloat(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_ENERGY, (LaserReleaseEnergy / 10000), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_RELEASE_TIME, (LaserReleaseTime / 1000), 1 , 1);		
		...
		case LASER_MODE_DERMA:{
			...
			SetTextFloat(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_POWER_CH0, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH0]) / 10), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_POWER_CH1, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH1]) / 10), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_TOTAL_POWER, ftemp, 1 , 1);
			...
			SetTextFloat(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_ENERGY, (LaserReleaseEnergy / 10000), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_RELEASE_TIME, (LaserReleaseTime / 1000), 1 , 1);		
			...
			switch(NVRAM0[EM_LASER_DERMA_SPOT_SIZE]){
				case DERMA_SPOT_SIZE_0MM5:{
					...
					SetTextFloat(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_ENERGY_DENSITY, (ftemp / 0.0019625), 1 , 1);
					break;
				}
				case DERMA_SPOT_SIZE_1MM0:{
					...
					SetButtonValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_2MM0, 0x00);
					SetButtonValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_3MM0, 0x00);
					SetTextFloat(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_ENERGY_DENSITY, (ftemp / 0.00785), 1 , 1);
					break;
				}
				case DERMA_SPOT_SIZE_2MM0:{
					...
					SetButtonValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_3MM0, 0x00);
					SetTextFloat(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_ENERGY_DENSITY, (ftemp / 0.0314926), 1 , 1);
					break;
				}
				case DERMA_SPOT_SIZE_3MM0:{
					...
					SetTextFloat(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_ENERGY_DENSITY, (ftemp / 0.0706853), 1 , 1);
					break;
				}
				default:break;
			}
			SetTextInt32(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_ENERGY_DENSITY, NVRAM0[EM_LASER_DERMA_NEGWIDTH], 1, 0);
		...
		case LASER_MODE_SIGNAL:{
			...
			SetButtonValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_GP, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_SP, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_SIGNAL, 0x01);
			SetButtonValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_DERMA, 0x00);
			SetTextInt32(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_ENERGY_INTERVAL, NVRAM0[EM_LASER_SIGNAL_ENERGY_INTERVAL], 1, 0);
...
static void updateOptionDisplay(void){//更新选项显示
	if(LD(MR_FOOSWITCH_HAND_SWITCH)){
		...
		SetButtonValue(GDDC_PAGE_OPTION_0, GDDC_PAGE_OPTION_KEY_HAND_SWITCH_OFF, 0x00);
	}
	else{
		SetButtonValue(GDDC_PAGE_OPTION_0, GDDC_PAGE_OPTION_KEY_HAND_SWITCH_ON, 0x00);
		SetButtonValue(GDDC_PAGE_OPTION_0, GDDC_PAGE_OPTION_KEY_HAND_SWITCH_OFF, 0x01);
	}
				...
				case GDDC_PAGE_STANDBY_CW_KEY_POWER_CH0_ADD:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_POWER_CH0] < CONFIG_MAX_LASERPOWER_CH0){
							...
							NVRAM0[EM_TOTAL_POWER] = NVRAM0[EM_LASER_POWER_CH0] + NVRAM0[EM_LASER_POWER_CH1];
							SetTextFloat(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_POWER_CH0, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH0]) / 10), 1 , 1);		
							SetTextInt32(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_TOTAL_POWER ,NVRAM0[EM_TOTAL_POWER], 1, 0);
							SetProgressValue(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_CW_PROGRESS_CH0, ((uint32_t)NVRAM0[EM_LASER_POWER_CH0] * 100 / CONFIG_MAX_LASERPOWER_CH0));						
						}
					}
					break;
				...
				case GDDC_PAGE_STANDBY_CW_KEY_POWER_CH1_ADD:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_POWER_CH1] < CONFIG_MAX_LASERPOWER_CH1){
							...
							NVRAM0[EM_TOTAL_POWER] = NVRAM0[EM_LASER_POWER_CH0] + NVRAM0[EM_LASER_POWER_CH1];
							SetTextFloat(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_POWER_CH1, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH1]) / 10), 1 , 1);
							SetTextFloat(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_TOTAL_POWER, ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 10), 1 , 1);
							SetProgressValue(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_CW_PROGRESS_CH1, ((uint32_t)NVRAM0[EM_LASER_POWER_CH1] * 100 / CONFIG_MAX_LASERPOWER_CH1));
						}
					}
					break;
				...
				case GDDC_PAGE_STANDBY_SP_KEY_POWER_CH0_ADD:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_POWER_CH0] < CONFIG_MAX_LASERPOWER_CH0){
							...
							NVRAM0[EM_TOTAL_POWER] = NVRAM0[EM_LASER_POWER_CH0] + NVRAM0[EM_LASER_POWER_CH1];
							SetTextFloat(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_POWER_CH0, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH0]) / 10), 1 , 1);		
							SetTextInt32(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_TOTAL_POWER ,NVRAM0[EM_TOTAL_POWER], 1, 0);
							SetProgressValue(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_SP_PROGRESS_CH0, ((uint32_t)NVRAM0[EM_LASER_POWER_CH0] * 100 / CONFIG_MAX_LASERPOWER_CH0));						
						}
					}
					break;
				...
				case GDDC_PAGE_STANDBY_MP_KEY_POWER_CH0_ADD:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_POWER_CH0] < CONFIG_MAX_LASERPOWER_CH0){
							...
							NVRAM0[EM_TOTAL_POWER] = NVRAM0[EM_LASER_POWER_CH0] + NVRAM0[EM_LASER_POWER_CH1];
							SetTextFloat(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_POWER_CH0, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH0]) / 10), 1 , 1);		
							SetTextInt32(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_TOTAL_POWER ,NVRAM0[EM_TOTAL_POWER], 1, 0);
							SetProgressValue(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_MP_PROGRESS_CH0, ((uint32_t)NVRAM0[EM_LASER_POWER_CH0] * 100 / CONFIG_MAX_LASERPOWER_CH0));						
						}
					}
					break;
				...
				case GDDC_PAGE_STANDBY_MP_KEY_POWER_CH1_ADD:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_POWER_CH1] < CONFIG_MAX_LASERPOWER_CH1){
							...
							NVRAM0[EM_TOTAL_POWER] = NVRAM0[EM_LASER_POWER_CH0] + NVRAM0[EM_LASER_POWER_CH1];
							SetTextFloat(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_POWER_CH1, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH1]) / 10), 1 , 1);
							SetTextFloat(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_TOTAL_POWER, ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 10), 1 , 1);
							SetProgressValue(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_MP_PROGRESS_CH1, ((uint32_t)NVRAM0[EM_LASER_POWER_CH1] * 100 / CONFIG_MAX_LASERPOWER_CH1));
						}
					}
					break;
				...
				case GDDC_PAGE_STANDBY_GP_KEY_POWER_CH0_ADD:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_POWER_CH0] < CONFIG_MAX_LASERPOWER_CH0){
							...
							NVRAM0[EM_TOTAL_POWER] = NVRAM0[EM_LASER_POWER_CH0] + NVRAM0[EM_LASER_POWER_CH1];
							SetTextFloat(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_POWER_CH0, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH0]) / 10), 1 , 1);		
							SetTextInt32(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_TOTAL_POWER ,NVRAM0[EM_TOTAL_POWER], 1, 0);
							SetProgressValue(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_GP_PROGRESS_CH0, ((uint32_t)NVRAM0[EM_LASER_POWER_CH0] * 100 / CONFIG_MAX_LASERPOWER_CH0));						
						}
					}
					break;
				...
				case GDDC_PAGE_STANDBY_GP_KEY_POWER_CH1_ADD:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_POWER_CH1] < CONFIG_MAX_LASERPOWER_CH1){
							...
							NVRAM0[EM_TOTAL_POWER] = NVRAM0[EM_LASER_POWER_CH0] + NVRAM0[EM_LASER_POWER_CH1];
							SetTextFloat(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_POWER_CH1, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH1]) / 10), 1 , 1);
							SetTextFloat(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_TOTAL_POWER, ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 10), 1 , 1);
							SetProgressValue(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_GP_PROGRESS_CH1, ((uint32_t)NVRAM0[EM_LASER_POWER_CH1] * 100 / CONFIG_MAX_LASERPOWER_CH1));
						}
					}
					break;
				...
				case GDDC_PAGE_STANDBY_SIGNAL_KEY_POWER_CH0_ADD:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_POWER_CH0] < CONFIG_MAX_LASERPOWER_CH0){
							ADDS1(EM_LASER_POWER_CH0);
							NVRAM0[EM_TOTAL_POWER] = NVRAM0[EM_LASER_POWER_CH0] + NVRAM0[EM_LASER_POWER_CH1];
							SetTextFloat(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_POWER_CH0, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH0]) / 10), 1 , 1);		
							SetTextInt32(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_TOTAL_POWER ,NVRAM0[EM_TOTAL_POWER], 1, 0);
				...
				case GDDC_PAGE_STANDBY_SIGNAL_KEY_POWER_CH1_DEC:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_POWER_CH1] > CONFIG_MIN_LASERPOWER_CH1){
							DECS1(EM_LASER_POWER_CH1);
							NVRAM0[EM_TOTAL_POWER] = NVRAM0[EM_LASER_POWER_CH0] + NVRAM0[EM_LASER_POWER_CH1];
							SetTextFloat(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_POWER_CH1, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH1]) / 10), 1 , 1);
							SetTextFloat(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_TOTAL_POWER, ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 10), 1 , 1);
				...
				case GDDC_PAGE_STANDBY_SIGNAL_KEY_ENERGY_INTERVAL_ADD:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_SIGNAL_ENERGY_INTERVAL] < CONFIG_MAX_LASER_ENERGY_INTERVAL){
							...
							SetTextInt32(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_ENERGY_INTERVAL , (NVRAM0[EM_LASER_SIGNAL_ENERGY_INTERVAL] * CONFIG_LASER_ENERGY_INTERVAL), 1, 0);
						}
					}
					break;
				}
				...
				case GDDC_PAGE_STANDBY_DERMA_KEY_POWER_CH0_ADD:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_POWER_CH0] < CONFIG_MAX_LASERPOWER_CH0){
							...
							NVRAM0[EM_TOTAL_POWER] = NVRAM0[EM_LASER_POWER_CH0] + NVRAM0[EM_LASER_POWER_CH1];
							SetTextFloat(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_POWER_CH0, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH0]) / 10), 1 , 1);		
							SetTextInt32(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_TOTAL_POWER ,NVRAM0[EM_TOTAL_POWER], 1, 0);
							SetProgressValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_PROGRESS_CH0, ((uint32_t)NVRAM0[EM_LASER_POWER_CH0] * 100 / CONFIG_MAX_LASERPOWER_CH0));						
						}
					}
					break;
				...
				case GDDC_PAGE_STANDBY_DERMA_KEY_POWER_CH1_ADD:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_POWER_CH1] < CONFIG_MAX_LASERPOWER_CH1){
							...
							NVRAM0[EM_TOTAL_POWER] = NVRAM0[EM_LASER_POWER_CH0] + NVRAM0[EM_LASER_POWER_CH1];
							SetTextFloat(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_POWER_CH1, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH1]) / 10), 1 , 1);
							SetTextFloat(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_TOTAL_POWER, ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 10), 1 , 1);
							SetProgressValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_PROGRESS_CH1, ((uint32_t)NVRAM0[EM_LASER_POWER_CH1] * 100 / CONFIG_MAX_LASERPOWER_CH1));
						}
					}
					break;
