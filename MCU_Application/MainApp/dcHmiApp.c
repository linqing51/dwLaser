...
//	SetTextInt32(GDDC_PAGE_SCHEME, GDDC_PAGE_SCHEME_TEXTDISPLAY_TIMES ,NVRAM0[(DM_LASER_TIMES + (NVRAM0[EM_SCHEME_NUM_TMP] * 25))], 1, 0);
//	SetTextInt32(GDDC_PAGE_SCHEME, GDDC_PAGE_SCHEME_TEXTDISPALY_GROUP_OFF ,NVRAM0[(DM_LASER_GROUP_OFF + (NVRAM0[EM_SCHEME_NUM_TMP] * 25))], 1, 0);
}
static void standbyTouchEnable(int8_t enable){//
	switch(NVRAM0[EM_LASER_PULSE_MODE]){
		case LASER_MODE_CW:{
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_POWER_CH0_ADD, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_POWER_CH0_DEC, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_POWER_CH1_ADD, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_POWER_CH1_DEC, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_MODE_CW, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_MODE_MP, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_MODE_GP, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_MODE_SP, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_MODE_SIGNAL, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_MODE_DERMA, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_ENTER_OPTION, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_ENTER_SCHEME, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_SCHEME_SAVE, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_SCHEME_NEXT, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_SCHEME_LAST, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_SELECT_CH0, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_SELECT_CH1, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_SELECT_BOTH, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_RESET, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_PROGRESS_CH0, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_PROGRESS_CH1, enable);
			if(enable){
				SetButtonValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_STANDBY, 0);
			}
			else{
				SetButtonValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_STANDBY, 1);
			}
			break;
		}
		case LASER_MODE_SP:{
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_POWER_CH0_ADD, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_POWER_CH0_DEC, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_POWER_CH1_ADD, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_POWER_CH1_DEC, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_MODE_CW, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_MODE_MP, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_MODE_GP, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_MODE_SP, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_MODE_SIGNAL, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_MODE_DERMA, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_ENTER_OPTION, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_ENTER_SCHEME, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_SCHEME_SAVE, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_SCHEME_NEXT, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_SCHEME_LAST, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_SELECT_CH0, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_SELECT_CH1, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_SELECT_BOTH, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_RESET, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_MODE_DERMA, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_PROGRESS_CH0, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_PROGRESS_CH1, enable);
			
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_POSWIDTH_ADD, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_POSWIDTH_DEC, enable);
			
			if(enable){
				SetButtonValue(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_STANDBY, 1);
			}
			else{
				SetButtonValue(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_STANDBY, 0);
			}
			
			break;
		}
		case LASER_MODE_MP:{
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_POWER_CH0_ADD, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_POWER_CH0_DEC, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_POWER_CH1_ADD, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_POWER_CH1_DEC, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_CW, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_MP, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_GP, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_SP, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_SIGNAL, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_DERMA, enable);		
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_ENTER_OPTION, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_ENTER_SCHEME, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_SCHEME_SAVE, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_SCHEME_NEXT, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_SCHEME_LAST, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_SELECT_CH0, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_SELECT_CH1, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_SELECT_BOTH, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_RESET, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_DERMA, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_PROGRESS_CH0, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_PROGRESS_CH1, enable);
				
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_POSWIDTH_ADD, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_POSWIDTH_DEC, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_NEGWIDTH_ADD, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_NEGWIDTH_DEC, enable);
			
			if(enable){
				SetButtonValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_STANDBY, 0);
			}
			else{
				SetButtonValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_STANDBY, 1);
			}
			break;
		}
		case LASER_MODE_GP:{
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_POWER_CH0_ADD, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_POWER_CH0_DEC, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_POWER_CH1_ADD, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_POWER_CH1_DEC, enable);
			
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_POSWIDTH_ADD, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_POSWIDTH_DEC, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_NEGWIDTH_ADD, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_NEGWIDTH_DEC, enable);

			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_TIMES_ADD, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_TIMES_DEC, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_GROUP_OFF_ADD, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_GROUP_OFF_DEC, enable);
			
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_CW, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_MP, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_GP, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_SP, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_SIGNAL, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_DERMA, enable);
			
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_ENTER_OPTION, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_ENTER_SCHEME, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_SCHEME_SAVE, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_SCHEME_NEXT, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_SCHEME_LAST, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_SELECT_CH0, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_SELECT_CH1, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_SELECT_BOTH, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_RESET, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_DERMA, enable);
			
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_PROGRESS_CH0, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_PROGRESS_CH1, enable);
			
			if(enable){
				SetButtonValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_STANDBY, 0);
			}
			else{
				SetButtonValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_STANDBY, 1);
			}
			break;
		}
		case LASER_MODE_DERMA:{
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_POWER_CH0_ADD, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_POWER_CH0_DEC, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_POWER_CH1_ADD, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_POWER_CH1_DEC, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_CW, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_MP, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_GP, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_SP, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_SIGNAL, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_DERMA, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_ENTER_OPTION, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_ENTER_SCHEME, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SCHEME_SAVE, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SCHEME_NEXT, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SCHEME_LAST, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SELECT_CH0, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SELECT_CH1, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SELECT_BOTH, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_RESET, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_DERMA, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_PROGRESS_CH0, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_PROGRESS_CH1, enable);
			
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_POSWIDTH_ADD, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_POSWIDTH_DEC, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_NEGWIDTH_ADD, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_NEGWIDTH_DEC, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_0MM5, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_1MM0, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_2MM0, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_3MM0, enable);	

			if(enable){
				SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_STANDBY, 0);
			}
			else{
				SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_STANDBY, 1);
			}
			break;
		}
		case LASER_MODE_SIGNAL:{
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_POWER_CH0_ADD, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_POWER_CH0_DEC, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_POWER_CH1_ADD, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_POWER_CH1_DEC, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_MODE_CW, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_MODE_MP, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_MODE_GP, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_MODE_SP, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_MODE_SIGNAL, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_MODE_DERMA, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_ENTER_OPTION, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_ENTER_SCHEME, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_SCHEME_SAVE, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_SCHEME_NEXT, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_SCHEME_LAST, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_SELECT_CH0, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_SELECT_CH1, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_SELECT_BOTH, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_RESET, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_MODE_SIGNAL, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_PROGRESS_CH0, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_PROGRESS_CH1, enable);
			
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_ENERGY_INTERVAL_ADD, enable);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_ENERGY_INTERVAL_DEC, enable);
			
			if(enable){
				SetButtonValue(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_STANDBY, 0);
			}
			else{
				SetButtonValue(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_STANDBY, 1);
			}
			break;
		}
		default:break;
...
static void updateStandbyDisplay(void){//更新方案显示
	...
	switch(NVRAM0[EM_LASER_PULSE_MODE]){
		case LASER_MODE_CW:{
			...
			SetTextFloat(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_POWER_CH0, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH0]) / 10), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_POWER_CH1, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH1]) / 10), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_TOTAL_POWER, ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 10), 1 , 1);
			SetProgressValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_PROGRESS_CH0, ((uint32_t)NVRAM0[EM_LASER_POWER_CH0] * 100 / CONFIG_MAX_LASERPOWER_CH0));
			SetProgressValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_PROGRESS_CH1, ((uint32_t)NVRAM0[EM_LASER_POWER_CH1] * 100 / CONFIG_MAX_LASERPOWER_CH1));
			SetTextValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_NAME, (char*)(&NVRAM0[EM_LASER_SCHEME_NAME]));		
			SetTextFloat(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_ENERGY, (LaserReleaseEnergy / 10000), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_RELEASE_TIME, (LaserReleaseTime / 1000), 1 , 1);
			SetButtonValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_MODE_CW, 0x01);
			SetButtonValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_MODE_MP, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_MODE_GP, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_MODE_SP, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_MODE_SIGNAL, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_MODE_DERMA, 0x00);
			NVRAM0[EM_DC_PAGE] = GDDC_PAGE_STANDBY_CW;
			break;			
		}
		case LASER_MODE_SP:{
			NVRAM0[EM_DC_PAGE] = GDDC_PAGE_STANDBY_SP;//切换待机页面
			SetTextFloat(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_POWER_CH0, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH0]) / 10), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_POWER_CH1, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH1]) / 10), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_TOTAL_POWER, ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 10), 1 , 1);
			SetProgressValue(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_PROGRESS_CH0, ((uint32_t)NVRAM0[EM_LASER_POWER_CH0] * 100 / CONFIG_MAX_LASERPOWER_CH0));
			SetProgressValue(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_PROGRESS_CH1, ((uint32_t)NVRAM0[EM_LASER_POWER_CH1] * 100 / CONFIG_MAX_LASERPOWER_CH1));
			SetTextValue(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_NAME, (char*)(&NVRAM0[EM_LASER_SCHEME_NAME]));		
			SetTextFloat(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_ENERGY, (LaserReleaseEnergy / 10000), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_RELEASE_TIME, (LaserReleaseTime / 1000), 1 , 1);		
			SetButtonValue(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_MODE_CW, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_MODE_MP, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_MODE_GP, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_MODE_SP, 0x01);
			SetButtonValue(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_MODE_SIGNAL, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_MODE_DERMA, 0x00);
			SetTextInt32(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_POSWIDTH ,NVRAM0[EM_LASER_SP_POSWIDTH], 1, 0);
			NVRAM0[EM_DC_PAGE] = GDDC_PAGE_STANDBY_SP;
			break;		
		}
		case LASER_MODE_MP:{
			NVRAM0[EM_DC_PAGE] = GDDC_PAGE_STANDBY_MP;//切换待机页面
			SetTextFloat(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_POWER_CH0, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH0]) / 10), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_POWER_CH1, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH1]) / 10), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_TOTAL_POWER, ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 10), 1 , 1);
			SetProgressValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_PROGRESS_CH0, ((uint32_t)NVRAM0[EM_LASER_POWER_CH0] * 100 / CONFIG_MAX_LASERPOWER_CH0));
			SetProgressValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_PROGRESS_CH1, ((uint32_t)NVRAM0[EM_LASER_POWER_CH1] * 100 / CONFIG_MAX_LASERPOWER_CH1));
			SetTextValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_NAME, (char*)(&NVRAM0[EM_LASER_SCHEME_NAME]));		
			SetTextFloat(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_ENERGY, (LaserReleaseEnergy / 10000), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_RELEASE_TIME, (LaserReleaseTime / 1000), 1 , 1);		
			SetButtonValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_CW, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_MP, 0x01);
			SetButtonValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_GP, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_SP, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_SIGNAL, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_DERMA, 0x00);
			SetTextInt32(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_POSWIDTH ,NVRAM0[EM_LASER_MP_POSWIDTH], 1, 0);
			SetTextInt32(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_NEGWIDTH ,NVRAM0[EM_LASER_MP_NEGWIDTH], 1, 0);
			NVRAM0[EM_DC_PAGE] = GDDC_PAGE_STANDBY_MP;
			break;
		}
		case LASER_MODE_GP:{
			NVRAM0[EM_DC_PAGE] = GDDC_PAGE_STANDBY_GP;//切换待机页面
			SetTextFloat(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_POWER_CH0, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH0]) / 10), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_POWER_CH1, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH1]) / 10), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_TOTAL_POWER, ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 10), 1 , 1);
			SetProgressValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_PROGRESS_CH0, ((uint32_t)NVRAM0[EM_LASER_POWER_CH0] * 100 / CONFIG_MAX_LASERPOWER_CH0));
			SetProgressValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_PROGRESS_CH1, ((uint32_t)NVRAM0[EM_LASER_POWER_CH1] * 100 / CONFIG_MAX_LASERPOWER_CH1));
			SetTextValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_NAME, (char*)(&NVRAM0[EM_LASER_SCHEME_NAME]));		
			SetTextFloat(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_ENERGY, (LaserReleaseEnergy / 10000), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_RELEASE_TIME, (LaserReleaseTime / 1000), 1 , 1);		
			SetButtonValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_CW, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_MP, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_GP, 0x01);
			SetButtonValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_SP, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_SIGNAL, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_DERMA, 0x00);
			SetTextInt32(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_POSWIDTH ,NVRAM0[EM_LASER_GP_POSWIDTH], 1, 0);
			SetTextInt32(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_NEGWIDTH ,NVRAM0[EM_LASER_GP_NEGWIDTH], 1, 0);
		...
		case LASER_MODE_DERMA:{
			...
			SetTextFloat(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_POWER_CH0, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH0]) / 10), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_POWER_CH1, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH1]) / 10), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_TOTAL_POWER, ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 10), 1 , 1);
			SetProgressValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_PROGRESS_CH0, ((uint32_t)NVRAM0[EM_LASER_POWER_CH0] * 100 / CONFIG_MAX_LASERPOWER_CH0));
			SetProgressValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_PROGRESS_CH1, ((uint32_t)NVRAM0[EM_LASER_POWER_CH1] * 100 / CONFIG_MAX_LASERPOWER_CH1));
			SetTextValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_NAME, (char*)(&NVRAM0[EM_LASER_SCHEME_NAME]));		
			SetTextFloat(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_ENERGY, (LaserReleaseEnergy / 10000), 1 , 1);
			SetTextFloat(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_RELEASE_TIME, (LaserReleaseTime / 1000), 1 , 1);		
			SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_CW, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_MP, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_GP, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_SP, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_SIGNAL, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_DERMA, 0x01);
			SetTextInt32(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_POSWIDTH, NVRAM0[EM_LASER_DERMA_POSWIDTH], 1, 0);
			SetTextInt32(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_NEGWIDTH, NVRAM0[EM_LASER_DERMA_NEGWIDTH], 1, 0);
			switch(NVRAM0[EM_LASER_DERMA_SPOT_SIZE]){
				case DERMA_SPOT_SIZE_0MM5:{
					...
					SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_1MM0, 0x00);
					SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_2MM0, 0x00);
					SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_3MM0, 0x00);
					SetTextFloat(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_ENERGY_DENSITY, ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 0.0019625), 1 , 1);
					break;
				}
				case DERMA_SPOT_SIZE_1MM0:{
					SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_0MM5, 0x00);
					SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_1MM0, 0x01);
					SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_2MM0, 0x00);
					SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_3MM0, 0x00);
					SetTextFloat(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_ENERGY_DENSITY, ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 0.00785), 1 , 1);
					break;
				}
				case DERMA_SPOT_SIZE_2MM0:{
					...
					SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_3MM0, 0x00);
					SetTextFloat(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_ENERGY_DENSITY, ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 0.0314926), 1 , 1);
					break;
				}
				case DERMA_SPOT_SIZE_3MM0:{
					...
					SetTextFloat(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_ENERGY_DENSITY, ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 0.0706853), 1 , 1);
					break;
				}
				default:break;
			}
			SetTextInt32(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_ENERGY_DENSITY, NVRAM0[EM_LASER_DERMA_NEGWIDTH], 1, 0);
		...
		case LASER_MODE_SIGNAL:{
			...
			SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_GP, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_SP, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_SIGNAL, 0x01);
			SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_DERMA, 0x00);
			SetTextInt32(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_ENERGY_INTERVAL, NVRAM0[EM_LASER_SIGNAL_ENERGY_INTERVAL], 1, 0);
...
void dcHmiLoop(void){//HMI轮训程序
	...
	if(NVRAM0[EM_HMI_OPERA_STEP] == FSMSTEP_POWERUP){//上电步骤	
		...
		RES(R_CHECK_SPI_MEMORY_DONE);					
		RES(R_CHECK_CH376_DONE);					
		RES(R_CHECK_DK25L_DONE);				
		...
		RES(R_STANDBY_KEY_ENERGY_INTERVAL_ADD_DOWN);
		RES(R_STANDBY_KEY_ENERGY_INTERVAL_ADD_UP);
		RES(R_STANDBY_KEY_ENERGY_INTERVAL_DEC_DOWN);
		RES(R_STANDBY_KEY_ENERGY_INTERVAL_DEC_UP);					

		RES( R_STANDBY_KEY_SPOT_0MM5_DOWN);
		RES( R_STANDBY_KEY_SPOT_0MM5_UP);	
		RES( R_STANDBY_KEY_SPOT_1MM0_DOWN);	
		RES( R_STANDBY_KEY_SPOT_1MM0_UP);		
		RES( R_STANDBY_KEY_SPOT_2MM0_DOWN);	
		RES( R_STANDBY_KEY_SPOT_2MM0_UP);	
		RES( R_STANDBY_KEY_SPOT_3MM0_DOWN);
		RES( R_STANDBY_KEY_SPOT_3MM0_UP);
	...
	if(NVRAM0[EM_HMI_OPERA_STEP] == FSMSTEP_RESTORE_HMI){//等待HMI复位
		...
		if(LD(T_100MS_START * 16 + T100MS_HMI_POWERUP_DELAY)){
			...
			SetTextValue(GDDC_PAGE_POWERUP, GDDC_PAGE_POWERUP_TEXTDISPLAY_CHECK_INFO, "Power Up");
			SetProgressValue(GDDC_PAGE_POWERUP, GDDC_PAGE_POWERUP_PROGRESS_CHECK_INFO, 0);			
			SetScreen(NVRAM0[EM_DC_PAGE]);	
	...
	if(NVRAM0[EM_HMI_OPERA_STEP] == FSMSTEP_CHECK_WIRELESS_FOOTCONTROL){//无线脚踏自检
		...
		if(LD(T_100MS_START * 16 + T100MS_CHECK_WIRELESS_FOOTCONTROL_DELAY)){
			...
			if(LDB(SPCOIL_WIRELESS_FOOTCONTROL_INIT_FAIL)){
				...
				RES(R_CHECK_WIRELESS_FOOTCONTROL_FAIL);
				SetTextValue(GDDC_PAGE_POWERUP, GDDC_PAGE_POWERUP_TEXTDISPLAY_CHECK_INFO, LANG_CHECK_DISPLAY_WIRELESS_FOOTCONTROL_PASS[NVRAM0[DM_LANGUAGE]]);
				...
				SetTextValue(GDDC_PAGE_POWERUP, GDDC_PAGE_POWERUP_TEXTDISPLAY_CHECK_INFO, LANG_CHECK_DISPLAY_WIRELESS_FOOTCONTROL_FAIL[NVRAM0[DM_LANGUAGE]]);
				NVRAM0[EM_HMI_OPERA_STEP] = FSMSTEP_CHECK_FAIL_DISPLAY;
			}
		}
		else{
				...
				if(LD(R_STANDBY_KEY_ENERGY_INTERVAL_ADD_DOWN)){//能量间隔加按键
					...
					if(LD(T_10MS_START * 16 + T10MS_ENERGY_INTERVAL_ADD_KEYDOWN_DELAY)){	
						if(LDP(SPCOIL_PS10MS) && (NVRAM0[EM_LASER_SIGNAL_ENERGY_INTERVAL] < CONFIG_MAX_LASER_ENERGY_INTERVAL)){
							ADDS1(EM_LASER_SIGNAL_ENERGY_INTERVAL);
				...
				if(LD(R_STANDBY_KEY_ENERGY_INTERVAL_DEC_DOWN)){//能量间隔减按键
					...
					if(LD(T_10MS_START * 16 + T10MS_ENERGY_INTERVAL_DEC_KEYDOWN_DELAY)){	
						if(LDP(SPCOIL_PS10MS) && (NVRAM0[EM_LASER_SIGNAL_ENERGY_INTERVAL] > CONFIG_MIN_LASER_GROUP_OFF)){
							DECS1(EM_LASER_SIGNAL_ENERGY_INTERVAL);
							SetTextInt32(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_ENERGY_INTERVAL, NVRAM0[EM_LASER_SIGNAL_ENERGY_INTERVAL], 1, 0);	
						}
					}
				}				
		...
		switch(NVRAM0[EM_LASER_PULSE_MODE]){
			case LASER_MODE_CW:{
				if(LDP(X_INTERLOCK)){//安全连锁拔出
					SetTextValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_WARN, LANG_WARN_MSG_INTERLOCK_UNPLUG[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(X_FOOTSWITCH_NC)){//脚踏拔出
					SetTextValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_WARN, LANG_WARN_MSG_FOOTSWITCH_UNPLUG[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(X_FBD0)){//光纤拔出
					SetTextValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_WARN, LANG_WARN_MSG_FIBER_UNPLUG[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(R_FIBER_ID_PASS_0)){//光纤ID不匹配
					SetTextValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_WARN, LANG_WARN_MSG_FIBER_MISSMATE[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(R_DIODE_TEMP_HIGH_0)){//激光器高温保护
					SetTextValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_WARN, LANG_WARN_MSG_DIODE0_HTEMP[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(R_ENVI_TEMP_HIGH)){//环境高温保护
					SetTextValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_WARN, LANG_WARN_MSG_ENVI_HTEMP[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(R_DRIVE_TEMP_HIGH)){//驱动器过热
					SetTextValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_WARN, LANG_WARN_MSG_DRIVE_HTEMP[NVRAM0[DM_LANGUAGE]]);
				}
				if(LDN(R_FAULT)){
					RES(SPCOIL_BEEM_ENABLE);//关闭蜂鸣器
					RES(Y_LED_ALARM);
					SetTextValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_WARN, LANG_WARN_MSG_NO_ERROR[NVRAM0[DM_LANGUAGE]]);
				}
				break;
			}
			case LASER_MODE_SP:{
				if(LDP(X_INTERLOCK)){//安全连锁拔出
					SetTextValue(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_WARN, LANG_WARN_MSG_INTERLOCK_UNPLUG[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(X_FOOTSWITCH_NC)){//脚踏拔出
					SetTextValue(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_WARN, LANG_WARN_MSG_FOOTSWITCH_UNPLUG[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(X_FBD0)){//光纤拔出
					SetTextValue(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_WARN, LANG_WARN_MSG_FIBER_UNPLUG[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(R_FIBER_ID_PASS_0)){//光纤ID不匹配
					SetTextValue(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_WARN, LANG_WARN_MSG_FIBER_MISSMATE[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(R_DIODE_TEMP_HIGH_0)){//激光器高温保护
					SetTextValue(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_WARN, LANG_WARN_MSG_DIODE0_HTEMP[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(R_ENVI_TEMP_HIGH)){//环境高温保护
					SetTextValue(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_WARN, LANG_WARN_MSG_ENVI_HTEMP[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(R_DRIVE_TEMP_HIGH)){//驱动器过热
					SetTextValue(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_WARN, LANG_WARN_MSG_DRIVE_HTEMP[NVRAM0[DM_LANGUAGE]]);
				}
				if(LDN(R_FAULT)){
					RES(SPCOIL_BEEM_ENABLE);//关闭蜂鸣器
					RES(Y_LED_ALARM);
					SetTextValue(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_WARN, LANG_WARN_MSG_NO_ERROR[NVRAM0[DM_LANGUAGE]]);
				}
				break;				
			}
			case LASER_MODE_MP:{
				if(LDP(X_INTERLOCK)){//安全连锁拔出
					SetTextValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_WARN, LANG_WARN_MSG_INTERLOCK_UNPLUG[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(X_FOOTSWITCH_NC)){//脚踏拔出
					SetTextValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_WARN, LANG_WARN_MSG_FOOTSWITCH_UNPLUG[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(X_FBD0)){//光纤拔出
					SetTextValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_WARN, LANG_WARN_MSG_FIBER_UNPLUG[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(R_FIBER_ID_PASS_0)){//光纤ID不匹配
					SetTextValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_WARN, LANG_WARN_MSG_FIBER_MISSMATE[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(R_DIODE_TEMP_HIGH_0)){//激光器高温保护
					SetTextValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_WARN, LANG_WARN_MSG_DIODE0_HTEMP[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(R_ENVI_TEMP_HIGH)){//环境高温保护
					SetTextValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_WARN, LANG_WARN_MSG_ENVI_HTEMP[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(R_DRIVE_TEMP_HIGH)){//驱动器过热
					SetTextValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_WARN, LANG_WARN_MSG_DRIVE_HTEMP[NVRAM0[DM_LANGUAGE]]);
				}
				if(LDN(R_FAULT)){
					RES(SPCOIL_BEEM_ENABLE);//关闭蜂鸣器
					RES(Y_LED_ALARM);
					SetTextValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_WARN, LANG_WARN_MSG_NO_ERROR[NVRAM0[DM_LANGUAGE]]);
				}
			}
			case LASER_MODE_GP:{
				if(LDP(X_INTERLOCK)){//安全连锁拔出
					SetTextValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_WARN, LANG_WARN_MSG_INTERLOCK_UNPLUG[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(X_FOOTSWITCH_NC)){//脚踏拔出
					SetTextValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_WARN, LANG_WARN_MSG_FOOTSWITCH_UNPLUG[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(X_FBD0)){//光纤拔出
					SetTextValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_WARN, LANG_WARN_MSG_FIBER_UNPLUG[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(R_FIBER_ID_PASS_0)){//光纤ID不匹配
					SetTextValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_WARN, LANG_WARN_MSG_FIBER_MISSMATE[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(R_DIODE_TEMP_HIGH_0)){//激光器高温保护
					SetTextValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_WARN, LANG_WARN_MSG_DIODE0_HTEMP[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(R_ENVI_TEMP_HIGH)){//环境高温保护
					SetTextValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_WARN, LANG_WARN_MSG_ENVI_HTEMP[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(R_DRIVE_TEMP_HIGH)){//驱动器过热
					SetTextValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_WARN, LANG_WARN_MSG_DRIVE_HTEMP[NVRAM0[DM_LANGUAGE]]);
				}
				if(LDN(R_FAULT)){
					RES(SPCOIL_BEEM_ENABLE);//关闭蜂鸣器
					RES(Y_LED_ALARM);
					SetTextValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_WARN, LANG_WARN_MSG_NO_ERROR[NVRAM0[DM_LANGUAGE]]);
				}			
			}
			case LASER_MODE_DERMA:{
				if(LDP(X_INTERLOCK)){//安全连锁拔出
					SetTextValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_WARN, LANG_WARN_MSG_INTERLOCK_UNPLUG[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(X_FOOTSWITCH_NC)){//脚踏拔出
					SetTextValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_WARN, LANG_WARN_MSG_FOOTSWITCH_UNPLUG[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(X_FBD0)){//光纤拔出
					SetTextValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_WARN, LANG_WARN_MSG_FIBER_UNPLUG[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(R_FIBER_ID_PASS_0)){//光纤ID不匹配
					SetTextValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_WARN, LANG_WARN_MSG_FIBER_MISSMATE[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(R_DIODE_TEMP_HIGH_0)){//激光器高温保护
					SetTextValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_WARN, LANG_WARN_MSG_DIODE0_HTEMP[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(R_ENVI_TEMP_HIGH)){//环境高温保护
					SetTextValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_WARN, LANG_WARN_MSG_ENVI_HTEMP[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(R_DRIVE_TEMP_HIGH)){//驱动器过热
					SetTextValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_WARN, LANG_WARN_MSG_DRIVE_HTEMP[NVRAM0[DM_LANGUAGE]]);
				}
				if(LDN(R_FAULT)){
					RES(SPCOIL_BEEM_ENABLE);//关闭蜂鸣器
					RES(Y_LED_ALARM);
					SetTextValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_WARN, LANG_WARN_MSG_NO_ERROR[NVRAM0[DM_LANGUAGE]]);
				}
			}
			case LASER_MODE_SIGNAL:{
				if(LDP(X_INTERLOCK)){//安全连锁拔出
					SetTextValue(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_WARN, LANG_WARN_MSG_INTERLOCK_UNPLUG[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(X_FOOTSWITCH_NC)){//脚踏拔出
					SetTextValue(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_WARN, LANG_WARN_MSG_FOOTSWITCH_UNPLUG[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(X_FBD0)){//光纤拔出
					SetTextValue(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_WARN, LANG_WARN_MSG_FIBER_UNPLUG[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(R_FIBER_ID_PASS_0)){//光纤ID不匹配
					SetTextValue(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_WARN, LANG_WARN_MSG_FIBER_MISSMATE[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(R_DIODE_TEMP_HIGH_0)){//激光器高温保护
					SetTextValue(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_WARN, LANG_WARN_MSG_DIODE0_HTEMP[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(R_ENVI_TEMP_HIGH)){//环境高温保护
					SetTextValue(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_WARN, LANG_WARN_MSG_ENVI_HTEMP[NVRAM0[DM_LANGUAGE]]);
				}
				else if(LDP(R_DRIVE_TEMP_HIGH)){//驱动器过热
					SetTextValue(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_WARN, LANG_WARN_MSG_DRIVE_HTEMP[NVRAM0[DM_LANGUAGE]]);
				}
				if(LDN(R_FAULT)){
					RES(SPCOIL_BEEM_ENABLE);//关闭蜂鸣器
					RES(Y_LED_ALARM);
					SetTextValue(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_WARN, LANG_WARN_MSG_NO_ERROR[NVRAM0[DM_LANGUAGE]]);
				}				
			} 
			default:break;
		}
	...
	if(NVRAM0[EM_HMI_OPERA_STEP] == FSMSTEP_READY_LOAD_DONE){//参数载入完毕并停止蜂鸣器
		...
		LaserReleaseEnergy = 0;
		LaserReleaseEnergy = 0;
		return;
	}
	if(NVRAM0[EM_HMI_OPERA_STEP] == FSMSTEP_LASER_WAIT_TRIGGER){//等待触发激光
		if(LD(R_STANDBY_KEY_STNADBY_DOWN) || LD(R_FAULT)){//回到等待状态
			EDLAR();//停止发射			
	...
	if(NVRAM0[EM_HMI_OPERA_STEP] == FSMSTEP_DIAGNOSIS){//诊断界面
		if(LD(R_DIAGNOSIS_OK_DOWN)){//返回Option
			...
			NVRAM0[EM_HMI_OPERA_STEP] = FSMSTEP_DIAGNOSIS;
			if(LDP(X_INTERLOCK) || LDN(X_INTERLOCK)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_X_INTERLOCK , LD(X_INTERLOCK), 1, 0);
			}
			if(LDP(X_ESTOP) || LDN(X_ESTOP)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_X_ESTOP , LD(X_ESTOP), 1, 0);
			}
			if(LDP(X_FOOTSWITCH_NO) || LDN(X_FOOTSWITCH_NO)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_X_FOOTSWITCH_NO , LD(X_FOOTSWITCH_NO), 1, 0);
			}
			if(LDP(X_FOOTSWITCH_NC) || LDN(X_FOOTSWITCH_NC)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_X_FOOTSWITCH_NC , LD(X_FOOTSWITCH_NC), 1, 0);
			}
			if(LDP(X_LDR_FAULT0) || LDN(X_LDR_FAULT0)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_X_LDR_FAULT0 , LD(X_LDR_FAULT0), 1, 0);
			}
			if(LDP(X_LDR_FAULT1) || LDN(X_LDR_FAULT1)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_X_LDR_FAULT1 , LD(X_LDR_FAULT1), 1, 0);
			}
			if(LDP(X_FBD0) || LDN(X_FBD0)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_X_FBD0 , LD(X_FBD0), 1, 0);
			}
			if(LDP(X_FBD1) || LDN(X_FBD1)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_X_FBD1 , LD(X_FBD1), 1, 0);
			}
			if(LDP(Y_LED_POWERON) || LDN(Y_LED_POWERON)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_Y_LED_POWERON , LD(Y_LED_POWERON), 1, 0);
			}
			if(LDP(Y_LED_EMIT) || LDN(Y_LED_EMIT)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_Y_LED_EMIT , LD(Y_LED_EMIT), 1, 0);
			}
			if(LDP(Y_LED_ALARM) || LDN(Y_LED_ALARM)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_Y_LED_ALARM , LD(Y_LED_ALARM), 1, 0);
			}
			if(LDP(Y_OUT3) || LDN(Y_OUT3)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_Y3 , LD(Y_OUT3), 1, 0);
			}
			if(LDP(Y_OUT4) || LDN(Y_OUT4)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_Y4 , LD(Y_OUT4), 1, 0);
			}
			if(LDP(Y_OUT5) || LDN(Y_OUT5)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_Y5 , LD(Y_OUT5), 1, 0);
			}
			if(LDP(Y_OUT6) || LDN(Y_OUT6)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_Y6 , LD(Y_OUT6), 1, 0);
			}
			if(LDP(Y_OUT7) || LDN(Y_OUT7)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_Y7 , LD(Y_OUT7), 1, 0);
			}
			if(LDP(Y_FAN0) || LDN(Y_FAN0)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_Y_FAN0 , LD(Y_FAN0), 1, 0);
			}
			if(LDP(Y_FAN1) || LDN(Y_FAN1)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_Y_FAN1 , LD(Y_FAN1), 1, 0);
			}
			if(LDP(Y_TEC0) || LDN(Y_TEC0)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_Y_TEC0 , LD(Y_TEC0), 1, 0);
			}
			if(LDP(Y_TEC1) || LDN(Y_TEC1)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_Y_TEC1 , LD(Y_TEC1), 1, 0);
			}
			if(LDP(SPCOIL_SPWM_OUT_0) || LDN(SPCOIL_SPWM_OUT_0)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_SPWM_OUT0 , LD(SPCOIL_SPWM_OUT_0), 1, 0);
			}
			if(LDP(SPCOIL_SPWM_OUT_1) || LDN(SPCOIL_SPWM_OUT_1)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_SPWM_OUT1 , LD(SPCOIL_SPWM_OUT_1), 1, 0);
			}
			if(LDP(SPCOIL_SPWM_OUT_2) || LDN(SPCOIL_SPWM_OUT_2)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_SPWM_OUT2 , LD(SPCOIL_SPWM_OUT_2), 1, 0);
			}
			if(LDP(SPCOIL_SPWM_OUT_3) || LDN(SPCOIL_SPWM_OUT_3)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_SPWM_OUT3 , LD(SPCOIL_SPWM_OUT_3), 1, 0);
			}			
			if(LDP(SPCOIL_SPWM_RESET_0) || LDN(SPCOIL_SPWM_RESET_0)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_SPWM_RESET0 , LD(SPCOIL_SPWM_RESET_0), 1, 0);
			}
			
			if(LDP(SPCOIL_SPWM_RESET_1) || LDN(SPCOIL_SPWM_RESET_1)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_SPWM_RESET1 , LD(SPCOIL_SPWM_RESET_1), 1, 0);
			}			
			if(LDP(SPCOIL_SPWM_RESET_2) || LDN(SPCOIL_SPWM_RESET_2)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_SPWM_RESET2 , LD(SPCOIL_SPWM_RESET_2), 1, 0);
			}
						
			if(LDP(SPCOIL_SPWM_RESET_3) || LDN(SPCOIL_SPWM_RESET_3)){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_SPWM_RESET3 , LD(SPCOIL_SPWM_RESET_3), 1, 0);
			}
			if(NVRAM0[SPREG_ADC_0] != NVRAM1[SPREG_ADC_0]){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_ADC0 , NVRAM0[SPREG_ADC_0], 1, 0);
			}
			if(NVRAM0[SPREG_ADC_1] != NVRAM1[SPREG_ADC_1]){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_ADC1 , NVRAM0[SPREG_ADC_1], 1, 0);
			}
			if(NVRAM0[SPREG_ADC_2] != NVRAM1[SPREG_ADC_2]){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_ADC2 , NVRAM0[SPREG_ADC_2], 1, 0);
			}
			if(NVRAM0[SPREG_ADC_3] != NVRAM1[SPREG_ADC_3]){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_ADC3 , NVRAM0[SPREG_ADC_3], 1, 0);
			}
			if(NVRAM0[SPREG_ADC_4] != NVRAM1[SPREG_ADC_4]){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_ADC4 , NVRAM0[SPREG_ADC_4], 1, 0);
			}
			if(NVRAM0[SPREG_ADC_5] != NVRAM1[SPREG_ADC_5]){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_ADC5 , NVRAM0[SPREG_ADC_5], 1, 0);
			}
			if(NVRAM0[SPREG_ADC_6] != NVRAM1[SPREG_ADC_6]){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_ADC6 , NVRAM0[SPREG_ADC_6], 1, 0);
			}
			if(NVRAM0[SPREG_ADC_7] != NVRAM1[SPREG_ADC_7]){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_ADC7 , NVRAM0[SPREG_ADC_7], 1, 0);
			}
			if(NVRAM0[SPREG_ADC_8] != NVRAM1[SPREG_ADC_8]){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_ADC8 , NVRAM0[SPREG_ADC_8], 1, 0);
			}
			if(NVRAM0[SPREG_DAC_0] != NVRAM1[SPREG_DAC_0]){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_DAC0 , NVRAM0[SPREG_DAC_0], 1, 0);
			}
			if(NVRAM0[SPREG_DAC_1] != NVRAM1[SPREG_DAC_1]){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_DAC1 , NVRAM0[SPREG_DAC_1], 1, 0);
			}
			if(NVRAM0[SPREG_SPWM_POS_0] != NVRAM1[SPREG_SPWM_POS_0]){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_SPWM_POS0 , NVRAM0[SPREG_SPWM_POS_0], 1, 0);
			}
			if(NVRAM0[SPREG_SPWM_POS_1] != NVRAM1[SPREG_SPWM_POS_1]){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_SPWM_POS1 , NVRAM0[SPREG_SPWM_POS_1], 1, 0);
			}
			if(NVRAM0[SPREG_SPWM_POS_3] != NVRAM1[SPREG_SPWM_POS_2]){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_SPWM_POS2 , NVRAM0[SPREG_SPWM_POS_2], 1, 0);
			}
			if(NVRAM0[SPREG_SPWM_POS_3] != NVRAM1[SPREG_SPWM_POS_3]){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_SPWM_POS3 , NVRAM0[SPREG_SPWM_POS_3], 1, 0);
			}
			if(NVRAM0[SPREG_SPWM_CYCLE_0] != NVRAM1[SPREG_SPWM_CYCLE_0]){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_SPWM_CYCLE0 , NVRAM0[SPREG_SPWM_CYCLE_0], 1, 0);
			}
			if(NVRAM0[SPREG_SPWM_CYCLE_1] != NVRAM1[SPREG_SPWM_CYCLE_1]){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_SPWM_CYCLE1 , NVRAM0[SPREG_SPWM_CYCLE_1], 1, 0);
			}
			if(NVRAM0[SPREG_SPWM_CYCLE_2] != NVRAM1[SPREG_SPWM_CYCLE_2]){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_SPWM_CYCLE2 , NVRAM0[SPREG_SPWM_CYCLE_2], 1, 0);
			}
			if(NVRAM0[SPREG_SPWM_CYCLE_3] != NVRAM1[SPREG_SPWM_CYCLE_3]){
				SetTextInt32(GDDC_PAGE_DIAGNOSIS, GDDC_PAGE_DIAGNOSIS_TEXTDISPLAY_SPWM_CYCLE3 , NVRAM0[SPREG_SPWM_CYCLE_3], 1, 0);
			}	
		}
		return;
			...
			switch(control_id){				
				case GDDC_PAGE_STANDBY_CW_KEY_POWER_CH0_ADD:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_POWER_CH0] < CONFIG_MAX_LASERPOWER_CH0){
							...
							NVRAM0[EM_TOTAL_POWER] = NVRAM0[EM_LASER_POWER_CH0] + NVRAM0[EM_LASER_POWER_CH1];
							SetTextFloat(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_POWER_CH0, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH0]) / 10), 1 , 1);		
							SetTextInt32(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_TOTAL_POWER ,NVRAM0[EM_TOTAL_POWER], 1, 0);
							SetProgressValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_PROGRESS_CH0, ((uint32_t)NVRAM0[EM_LASER_POWER_CH0] * 100 / CONFIG_MAX_LASERPOWER_CH0));						
						}
					}
					break;
				...
				case GDDC_PAGE_STANDBY_CW_KEY_SELECT_CH0:{
					if(state == 0x01){
						...
						SetButtonValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_SELECT_CH1, 0x00);
						SetButtonValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_SELECT_BOTH, 0x00);
					}
					break;
				}
				case GDDC_PAGE_STANDBY_CW_KEY_SELECT_CH1:{
					if(state == 0x01){
						...
						SetButtonValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_SELECT_CH0, 0x00);
						SetButtonValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_SELECT_BOTH, 0x00);
					}
					break;
				}
				...
				case GDDC_PAGE_STANDBY_CW_KEY_RESET:{
					if(state == 0x01){
						LaserReleaseTime = 0;
						LaserReleaseEnergy = 0;
						SetButtonValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_RESET, 0x00);
					}
					break;
				}	
				...
				case GDDC_PAGE_STANDBY_SP_KEY_POWER_CH0_ADD:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_POWER_CH0] < CONFIG_MAX_LASERPOWER_CH0){
							...
							NVRAM0[EM_TOTAL_POWER] = NVRAM0[EM_LASER_POWER_CH0] + NVRAM0[EM_LASER_POWER_CH1];
							SetTextFloat(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_POWER_CH0, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH0]) / 10), 1 , 1);		
							SetTextInt32(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_TEXTDISPLAY_TOTAL_POWER ,NVRAM0[EM_TOTAL_POWER], 1, 0);
							SetProgressValue(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_PROGRESS_CH0, ((uint32_t)NVRAM0[EM_LASER_POWER_CH0] * 100 / CONFIG_MAX_LASERPOWER_CH0));						
						}
					}
					break;
		...
		case GDDC_PAGE_STANDBY_MP:{//主界面STANDBY MP
			switch(control_id){				
				case GDDC_PAGE_STANDBY_MP_KEY_POWER_CH0_ADD:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_POWER_CH0] < CONFIG_MAX_LASERPOWER_CH0){
							...
							NVRAM0[EM_TOTAL_POWER] = NVRAM0[EM_LASER_POWER_CH0] + NVRAM0[EM_LASER_POWER_CH1];
							SetTextFloat(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_POWER_CH0, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH0]) / 10), 1 , 1);		
							SetTextInt32(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_TOTAL_POWER ,NVRAM0[EM_TOTAL_POWER], 1, 0);
							SetProgressValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_PROGRESS_CH0, ((uint32_t)NVRAM0[EM_LASER_POWER_CH0] * 100 / CONFIG_MAX_LASERPOWER_CH0));						
						}
					}
					break;
				...
				case GDDC_PAGE_STANDBY_MP_KEY_SELECT_CH0:{
					if(state == 0x01){
						NVRAM0[EM_LASER_SELECT] = LASER_SELECT_CH0;
						SetButtonValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_SELECT_CH1, 0x00);
						SetButtonValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_SELECT_BOTH, 0x00);
					}
					break;
				}
				case GDDC_PAGE_STANDBY_MP_KEY_SELECT_CH1:{
					if(state == 0x01){
						NVRAM0[EM_LASER_SELECT] = LASER_SELECT_CH1;
						SetButtonValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_SELECT_CH0, 0x00);
						SetButtonValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_SELECT_BOTH, 0x00);
					}
					break;
				}
				...
				case GDDC_PAGE_STANDBY_MP_KEY_RESET:{
					if(state == 0x01){
						LaserReleaseTime = 0;
						LaserReleaseEnergy = 0;
						SetButtonValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_RESET, 0x00);
					}
					break;
				}	
		...
		case GDDC_PAGE_STANDBY_GP:{//主界面STANDBY GP
			switch(control_id){				
				case GDDC_PAGE_STANDBY_GP_KEY_POWER_CH0_ADD:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_POWER_CH0] < CONFIG_MAX_LASERPOWER_CH0){
							...
							NVRAM0[EM_TOTAL_POWER] = NVRAM0[EM_LASER_POWER_CH0] + NVRAM0[EM_LASER_POWER_CH1];
							SetTextFloat(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_POWER_CH0, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH0]) / 10), 1 , 1);		
							SetTextInt32(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_TOTAL_POWER ,NVRAM0[EM_TOTAL_POWER], 1, 0);
							SetProgressValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_PROGRESS_CH0, ((uint32_t)NVRAM0[EM_LASER_POWER_CH0] * 100 / CONFIG_MAX_LASERPOWER_CH0));						
						}
					}
					break;
				...
				case GDDC_PAGE_STANDBY_GP_KEY_SELECT_CH0:{
					if(state == 0x01){
						NVRAM0[EM_LASER_SELECT] = LASER_SELECT_CH0;
						SetButtonValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_SELECT_CH1, 0x00);
						SetButtonValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_SELECT_BOTH, 0x00);
					}
					break;
				}
				case GDDC_PAGE_STANDBY_GP_KEY_SELECT_CH1:{
					if(state == 0x01){
						NVRAM0[EM_LASER_SELECT] = LASER_SELECT_CH1;
						SetButtonValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_SELECT_CH0, 0x00);
						SetButtonValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_SELECT_BOTH, 0x00);
					}
					break;
				}
				...
				case GDDC_PAGE_STANDBY_GP_KEY_RESET:{
					if(state == 0x01){
						LaserReleaseTime = 0;
						LaserReleaseEnergy = 0;
						SetButtonValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_RESET, 0x00);
					}
					break;
				}	
		...
		case GDDC_PAGE_STANDBY_SIGNAL:{//主界面STANDBY EVLA SIGNAL
			switch(control_id){				
				case GDDC_PAGE_STANDBY_SIGNAL_KEY_POWER_CH0_ADD:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_POWER_CH0] < CONFIG_MAX_LASERPOWER_CH0){
							ADDS1(EM_LASER_POWER_CH0);
							NVRAM0[EM_TOTAL_POWER] = NVRAM0[EM_LASER_POWER_CH0] + NVRAM0[EM_LASER_POWER_CH1];
							SetTextFloat(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_POWER_CH0, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH0]) / 10), 1 , 1);		
							SetTextInt32(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_TOTAL_POWER ,NVRAM0[EM_TOTAL_POWER], 1, 0);
							SetProgressValue(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_PROGRESS_CH0, ((uint32_t)NVRAM0[EM_LASER_POWER_CH0] * 100 / CONFIG_MAX_LASERPOWER_CH0));						
						}
					}
					break;
				}
				...
				case GDDC_PAGE_STANDBY_SIGNAL_KEY_POWER_CH1_DEC:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_POWER_CH1] > CONFIG_MIN_LASERPOWER_CH1){
							DECS1(EM_LASER_POWER_CH1);
							NVRAM0[EM_TOTAL_POWER] = NVRAM0[EM_LASER_POWER_CH0] + NVRAM0[EM_LASER_POWER_CH1];
							SetTextFloat(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_POWER_CH1, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH1]) / 10), 1 , 1);
							SetTextFloat(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_TOTAL_POWER, ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 10), 1 , 1);
							SetProgressValue(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_PROGRESS_CH1, ((uint32_t)NVRAM0[EM_LASER_POWER_CH1] * 100 / CONFIG_MAX_LASERPOWER_CH1));
						}
					}
					break;
				}
				case GDDC_PAGE_STANDBY_SIGNAL_KEY_ENERGY_INTERVAL_ADD:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_SIGNAL_ENERGY_INTERVAL] < CONFIG_MAX_LASER_ENERGY_INTERVAL){
							NVRAM0[EM_LASER_SIGNAL_ENERGY_INTERVAL] += 1;
							SetTextInt32(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_ENERGY_INTERVAL , (NVRAM0[EM_LASER_SIGNAL_ENERGY_INTERVAL] * CONFIG_LASER_ENERGY_INTERVAL), 1, 0);
						}
					}
					break;
				}
				...
				case GDDC_PAGE_STANDBY_SIGNAL_KEY_SELECT_BOTH:{
					if(state == 0x01){
						NVRAM0[EM_LASER_SELECT] = LASER_SELECT_BOTH;
						SetButtonValue(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_SELECT_CH0, 0x00);
						SetButtonValue(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_SELECT_CH1, 0x00);
					}
					break;
				}	
		...
		case GDDC_PAGE_STANDBY_DERMA:{//主界面STNADBY DERMA
			switch(control_id){	
				case GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_0MM5:{
					if(state == 0x01){
						SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_0MM5, true);
				...
				case GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_1MM0:{
					if(state == 0x01){
						...
						SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_1MM0, true);
						SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_2MM0, false);
						SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_3MM0, false);
				...
				case GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_2MM0:{
					if(state == 0x01){
						SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_0MM5, false);
						SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_1MM0, false);
						SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_2MM0, true);
						SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_3MM0, false);
				...
				case GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_3MM0:{
					if(state == 0x01){
						...
						SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_1MM0, false);
						SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_2MM0, false);
						SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_3MM0, true);
				...
				case GDDC_PAGE_STANDBY_DERMA_KEY_POWER_CH0_ADD:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_POWER_CH0] < CONFIG_MAX_LASERPOWER_CH0){
							...
							NVRAM0[EM_TOTAL_POWER] = NVRAM0[EM_LASER_POWER_CH0] + NVRAM0[EM_LASER_POWER_CH1];
							SetTextFloat(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_POWER_CH0, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH0]) / 10), 1 , 1);		
							SetTextInt32(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_TEXTDISPLAY_TOTAL_POWER ,NVRAM0[EM_TOTAL_POWER], 1, 0);
							SetProgressValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_PROGRESS_CH0, ((uint32_t)NVRAM0[EM_LASER_POWER_CH0] * 100 / CONFIG_MAX_LASERPOWER_CH0));						
						}
					}
					break;
				...
				case GDDC_PAGE_STANDBY_DERMA_KEY_SELECT_CH0:{
					if(state == 0x01){
						NVRAM0[EM_LASER_SELECT] = LASER_SELECT_CH0;
						SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SELECT_CH1, 0x00);
						SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SELECT_BOTH, 0x00);
					}
					break;
				}
				case GDDC_PAGE_STANDBY_DERMA_KEY_SELECT_CH1:{
					if(state == 0x01){
						NVRAM0[EM_LASER_SELECT] = LASER_SELECT_CH1;
						SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SELECT_CH0, 0x00);
						SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SELECT_BOTH, 0x00);
					}
					break;
				}
				...
				case GDDC_PAGE_STANDBY_DERMA_KEY_RESET:{
					if(state == 0x01){
						LaserReleaseTime = 0;
						LaserReleaseEnergy = 0;
						SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_RESET, 0x00);
					}
					break;
				}	
