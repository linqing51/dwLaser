...
//工作状态
#define WORKSTEP_STANDBY							300//等待状态
#define WORKSTEP_READY_LOAD_PARA					301//载入参数
#define WORKSTEP_READY_LOAD_DONE					302//载入参数完毕
#define WORKSTEP_LASER_TRIGGER						303//激光触发
#define WORKSTEP_LASER_EMITING						304//激光发射中
#define WORKSTEP_LASER_STOP							305//激光发射结束
//选项状态
#define WORKSTEP_OPTION								400//选项菜单
...
void dcHmiLoop(void){//HMI轮训程序
	...
	if(NVRAM0[EM_HMI_OPERA_STEP] == WORKSTEP_POWERUP){//上电步骤	
		...
		NVRAM0[EM_DC_NEWPASSWORD0] = 0x0000;//00
		NVRAM0[EM_DC_NEWPASSWORD1] = 0x0000;//00
