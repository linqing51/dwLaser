...
#define FSMSTEP_CHECK_PN7150B0HN					206//NFC模块自检
...
void dcHmiLoop(void){//HMI轮训程序
	...
	if(NVRAM0[EM_HMI_OPERA_STEP] == FSMSTEP_CHECK_PN7150B0HN){
		T100MS(T100MS_CHECK_PN7150B0HN_DELAY, true, CONFIG_CHECK_DELAY_TIME);
		if(LD(T_100MS_START * 16 + T100MS_CHECK_PN7150B0HN_DELAY)){
			T100MS(T100MS_CHECK_PN7150B0HN_DELAY, false, CONFIG_CHECK_DELAY_TIME);
			SET(R_CHECK_PN7150B0HN_DONE);
			if(LDB(SPCOIL_PN7150B0HN_INIT_FAIL)){
