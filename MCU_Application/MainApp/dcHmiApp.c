...
static void standbyTouchSet(int8_t st){//
	switch(NVRAM0[EM_LASER_PULSE_MODE]){
		case LASER_MODE_CW:{
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_POWER_CH0_ADD, st);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_POWER_CH0_DEC, st);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_POWER_CH1_ADD, st);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_POWER_CH1_DEC, st);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_MODE_CW, st);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_MODE_MP, st);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_MODE_GP, st);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_MODE_SP, st);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_MODE_SIGNAL, st);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_MODE_DERMA, st);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_ENTER_OPTION, st);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_ENTER_SCHEME, st);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_SCHEME_SAVE, st);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_SCHEME_NEXT, st);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_SCHEME_LAST, st);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_SELECT_CH0, st);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_SELECT_CH1, st);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_SELECT_BOTH, st);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_RESET, st);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_PROGRESS_CH0, st);
			SetControlEnable(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_PROGRESS_CH1, st);
			break;
		}
		case LASER_MODE_SP:{
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_POWER_CH0_ADD, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_POWER_CH0_DEC, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_POWER_CH1_ADD, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_POWER_CH1_DEC, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_MODE_CW, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_MODE_MP, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_MODE_GP, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_MODE_SP, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_MODE_SIGNAL, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_MODE_DERMA, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_ENTER_OPTION, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_ENTER_SCHEME, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_SCHEME_SAVE, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_SCHEME_NEXT, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_SCHEME_LAST, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_SELECT_CH0, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_SELECT_CH1, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_SELECT_BOTH, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_RESET, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_MODE_DERMA, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_PROGRESS_CH0, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_PROGRESS_CH1, st);
			
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_POSWIDTH_ADD, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_POSWIDTH_DEC, st);
			break;
		}
		case LASER_MODE_MP:{
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_POWER_CH0_ADD, st);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_POWER_CH0_DEC, st);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_POWER_CH1_ADD, st);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_POWER_CH1_DEC, st);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_CW, st);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_MP, st);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_GP, st);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_SP, st);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_SIGNAL, st);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_DERMA, st);		
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_ENTER_OPTION, st);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_ENTER_SCHEME, st);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_SCHEME_SAVE, st);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_SCHEME_NEXT, st);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_SCHEME_LAST, st);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_SELECT_CH0, st);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_SELECT_CH1, st);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_SELECT_BOTH, st);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_RESET, st);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_DERMA, st);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_PROGRESS_CH0, st);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_PROGRESS_CH1, st);
				
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_POSWIDTH_ADD, st);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_POSWIDTH_DEC, st);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_NEGWIDTH_ADD, st);
			SetControlEnable(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_NEGWIDTH_DEC, st);
			break;
		}
		case LASER_MODE_GP:{
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_POWER_CH0_ADD, st);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_POWER_CH0_DEC, st);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_POWER_CH1_ADD, st);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_POWER_CH1_DEC, st);
			
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_POSWIDTH_ADD, st);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_POSWIDTH_DEC, st);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_NEGWIDTH_ADD, st);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_NEGWIDTH_DEC, st);

			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_TIMES_ADD, st);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_TIMES_DEC, st);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_GROUP_OFF_ADD, st);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_GROUP_OFF_DEC, st);
			
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_CW, st);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_MP, st);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_GP, st);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_SP, st);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_SIGNAL, st);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_DERMA, st);
			
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_ENTER_OPTION, st);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_ENTER_SCHEME, st);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_SCHEME_SAVE, st);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_SCHEME_NEXT, st);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_SCHEME_LAST, st);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_SELECT_CH0, st);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_SELECT_CH1, st);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_SELECT_BOTH, st);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_RESET, st);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_DERMA, st);
			
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_PROGRESS_CH0, st);
			SetControlEnable(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_PROGRESS_CH1, st);
			break;
		}
		case LASER_MODE_DERMA:{
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_POWER_CH0_ADD, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_POWER_CH0_DEC, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_POWER_CH1_ADD, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_POWER_CH1_DEC, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_CW, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_MP, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_GP, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_SP, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_SIGNAL, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_DERMA, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_ENTER_OPTION, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_ENTER_SCHEME, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SCHEME_SAVE, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SCHEME_NEXT, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SCHEME_LAST, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SELECT_CH0, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SELECT_CH1, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SELECT_BOTH, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_RESET, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_DERMA, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_PROGRESS_CH0, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_PROGRESS_CH1, st);
			
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_POSWIDTH_ADD, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_POSWIDTH_DEC, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_NEGWIDTH_ADD, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_NEGWIDTH_DEC, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_0MM5, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_1MM0, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_2MM0, st);
			SetControlEnable(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_SPOT_3MM0, st);					
			break;
		}
		case LASER_MODE_SIGNAL:{
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_POWER_CH0_ADD, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_POWER_CH0_DEC, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_POWER_CH1_ADD, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_POWER_CH1_DEC, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_MODE_CW, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_MODE_MP, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_MODE_GP, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_MODE_SP, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_MODE_SIGNAL, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_MODE_DERMA, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_ENTER_OPTION, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_ENTER_SCHEME, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_SCHEME_SAVE, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_SCHEME_NEXT, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_SCHEME_LAST, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_SELECT_CH0, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_SELECT_CH1, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_SELECT_BOTH, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_RESET, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_MODE_SIGNAL, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_PROGRESS_CH0, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_PROGRESS_CH1, st);
			
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_ENERGY_INTERVAL_ADD, st);
			SetControlEnable(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_KEY_ENERGY_INTERVAL_DEC, st);
			break;
		}
		default:break;
	}		
...
static void updateStandbyDisplay(void){//更新方案显示
	...
	switch(NVRAM0[EM_LASER_PULSE_MODE]){
		...
		case LASER_MODE_SIGNAL:{
			...
			SetTextInt32(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_ENERGY_INT, NVRAM0[EM_LASER_SIGNAL_ENERGY_INTERVAL], 1, 0);
...
static void updateOptionDisplay(void){//更新选项显示
	...
	SetProgressValue(GDDC_PAGE_OPTION, GDDC_PAGE_OPTION_PROGRESS_AIM_BRG, NVRAM0[DM_AIM_RED_BRG]);//更新进度条
...
void dcHmiLoop(void){//HMI轮训程序
	...
	if(NVRAM0[EM_HMI_OPERA_STEP] == FSMSTEP_POWERUP){//上电步骤	
		...
		RES(R_STANDBY_SP_KEY_POSWIDTH_ADD_DOWN);
		RES(R_STANDBY_SP_KEY_POSWIDTH_ADD_UP);					
		RES(R_STANDBY_MP_KEY_POSWIDTH_ADD_DOWN);					
		RES(R_STANDBY_MP_KEY_POSWIDTH_ADD_UP);						
		RES(R_STANDBY_GP_KEY_POSWIDTH_ADD_DOWN);					
		RES(R_STANDBY_GP_KEY_POSWIDTH_ADD_UP);						
		RES(R_STANDBY_DERMA_KEY_POSWIDTH_ADD_DOWN);				
		RES(R_STANDBY_DERMA_KEY_POSWIDTH_ADD_UP);						

		RES(R_STANDBY_SP_KEY_POSWIDTH_DEC_DOWN)	;				
		RES(R_STANDBY_SP_KEY_POSWIDTH_DEC_UP);						
		RES(R_STANDBY_MP_KEY_POSWIDTH_DEC_DOWN)	;					
		RES(R_STANDBY_MP_KEY_POSWIDTH_DEC_UP);						
		RES(R_STANDBY_GP_KEY_POSWIDTH_DEC_DOWN);					
		RES(R_STANDBY_GP_KEY_POSWIDTH_DEC_UP);					
		RES(R_STANDBY_DERMA_KEY_POSWIDTH_DEC_DOWN);					
		RES(R_STANDBY_DERMA_KEY_POSWIDTH_DEC_UP);						

		RES(R_STANDBY_MP_KEY_NEGWIDTH_ADD_DOWN);						
		RES(R_STANDBY_MP_KEY_NEGWIDTH_ADD_UP);						
		RES(R_STANDBY_GP_KEY_NEGWIDTH_ADD_DOWN)	;					
		RES(R_STANDBY_GP_KEY_NEGWIDTH_ADD_UP);						

		RES(R_STANDBY_GP_KEY_TIMES_ADD_DOWN);
		RES(R_STANDBY_GP_KEY_TIMES_ADD_UP);

		RES(R_STANDBY_GP_KEY_TIMES_DEC_DOWN);
		RES(R_STANDBY_GP_KEY_TIMES_DEC_UP);

		RES(R_STANDBY_GP_KEY_GROUP_OFF_ADD_DOWN);
		RES(R_STANDBY_GP_KEY_GROUP_OFF_ADD_UP);

		RES(R_STANDBY_GP_KEY_GROUP_OFF_DEC_DOWN);
		RES(R_STANDBY_GP_KEY_GROUP_OFF_DEC_UP)	;					
	...
	if(NVRAM0[EM_HMI_OPERA_STEP] == FSMSTEP_STANDBY){//待机状态机
		...
		if(LD(R_STANDBY_KEY_TIMES_ADD_DOWN)){//脉冲数加按键
			...
			if(LD(T_10MS_START * 16 + T10MS_TIMES_ADD_KEYDOWN_DELAY)){	
				if(LDP(SPCOIL_PS10MS) && (NVRAM0[EM_LASER_TIMES] < CONFIG_MAX_LASER_TIMES)){
					ADDS1(EM_LASER_TIMES);
					SetTextInt32(GDDC_PAGE_STANDBY, GDDC_PAGE_STANDBY_TEXTDISPLAY_TIMES ,NVRAM0[EM_LASER_TIMES], 1, 0);	
				}
			}
		}
		...
		if(LD(R_STANDBY_KEY_TIMES_DEC_DOWN)){//脉冲数减按键
			...
			if(LD(T_10MS_START * 16 + T10MS_TIMES_DEC_KEYDOWN_DELAY)){	
				if(LDP(SPCOIL_PS10MS) && (NVRAM0[EM_LASER_TIMES] > CONFIG_MIN_LASER_TIMES)){
					DECS1(EM_LASER_TIMES);
					SetTextInt32(GDDC_PAGE_STANDBY, GDDC_PAGE_STANDBY_TEXTDISPLAY_TIMES ,NVRAM0[EM_LASER_TIMES], 1, 0);	
				}
			}
		}
		...
		if(LD(R_STANDBY_KEY_GROUP_OFF_ADD_DOWN)){//脉冲间隔加按键
			...
			if(LD(T_10MS_START * 16 + T10MS_GROUP_OFF_ADD_KEYDOWN_DELAY)){	
				if(LDP(SPCOIL_PS10MS) && (NVRAM0[EM_LASER_GROUP_OFF] < CONFIG_MAX_LASER_GROUP_OFF)){
					ADDS1(EM_LASER_GROUP_OFF);
					SetTextInt32(GDDC_PAGE_STANDBY, GDDC_PAGE_STANDBY_TEXTDISPLAY_GROUP_OFF ,NVRAM0[EM_LASER_GROUP_OFF], 1, 0);	
				}
			}
		}
		...
		if(LD(R_STANDBY_KEY_GROUP_OFF_DEC_DOWN)){//脉冲间隔减按键
			...
			if(LD(T_10MS_START * 16 + T10MS_GROUP_OFF_DEC_KEYDOWN_DELAY)){	
				if(LDP(SPCOIL_PS10MS) && (NVRAM0[EM_LASER_GROUP_OFF] > CONFIG_MIN_LASER_GROUP_OFF)){
					DECS1(EM_LASER_GROUP_OFF);
					SetTextInt32(GDDC_PAGE_STANDBY, GDDC_PAGE_STANDBY_TEXTDISPLAY_GROUP_OFF ,NVRAM0[EM_LASER_GROUP_OFF], 1, 0);	
				}
			}
		}
		...
		if(LDP(X_INTERLOCK)){//安全连锁拔出
			...
			SetTextValue(GDDC_PAGE_STANDBY, GDDC_PAGE_STANDBY_TEXTDISPLAY_WARN, LANG_WARN_MSG_FOOTSWITCH_UNPLUG[NVRAM0[DM_LANGUAGE]]);
		}
		else if(LDP(X_FBD0)){//光纤拔出
			SetTextValue(GDDC_PAGE_STANDBY, GDDC_PAGE_STANDBY_TEXTDISPLAY_WARN, LANG_WARN_MSG_FIBER_UNPLUG[NVRAM0[DM_LANGUAGE]]);
		}
		else if(LDP(R_FIBER_ID_PASS_0)){//光纤ID不匹配
			SetTextValue(GDDC_PAGE_STANDBY, GDDC_PAGE_STANDBY_TEXTDISPLAY_WARN, LANG_WARN_MSG_FIBER_MISSMATE[NVRAM0[DM_LANGUAGE]]);
		}
		else if(LDP(R_DIODE_TEMP_HIGH_0)){//激光器高温保护
			SetTextValue(GDDC_PAGE_STANDBY, GDDC_PAGE_STANDBY_TEXTDISPLAY_WARN, LANG_WARN_MSG_DIODE0_HTEMP[NVRAM0[DM_LANGUAGE]]);
		}
		else if(LDP(R_ENVI_TEMP_HIGH)){//环境高温保护
			SetTextValue(GDDC_PAGE_STANDBY, GDDC_PAGE_STANDBY_TEXTDISPLAY_WARN, LANG_WARN_MSG_ENVI_HTEMP[NVRAM0[DM_LANGUAGE]]);
		}
	...
	if(NVRAM0[EM_HMI_OPERA_STEP] == FSMSTEP_READY_LOAD_PARA){//将发射参数载入运行寄存器并打开蜂鸣器
		...
		NVRAM0[SPREG_LASER_PMATE] = NVRAM0[EM_LASER_TIMES];//10个脉冲
		NVRAM0[SPREG_LASER_POVERTIME] = NVRAM0[EM_LASER_GROUP_OFF];//间隔33mS
#if CONFIG_USING_BACKGROUND_APP == 1
...
//			if(LD(R_LASER_EMIT_0) || LD(R_LASER_EMIT_0)){
	...
	switch(screen_id){
		...
		case GDDC_PAGE_STANDBY_CW:{//主界面STANDBY CW
			switch(control_id){				
				case GDDC_PAGE_STANDBY_CW_KEY_POWER_CH0_ADD:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_POWER_CH0] < CONFIG_MAX_LASERPOWER_CH0){
							...
							SetTextInt32(GDDC_PAGE_STANDBY, GDDC_PAGE_STANDBY_TEXTDISPLAY_TOTAL_POWER ,NVRAM0[EM_TOTAL_POWER], 1, 0);
				...
				case GDDC_PAGE_STANDBY_CW_KEY_ENTER_STANDBY:{
					if(state == 0x01){
		...
		case GDDC_PAGE_STANDBY_SP:{//主界面STANDBY SP
			switch(control_id){
				...
				case GDDC_PAGE_STANDBY_SP_KEY_POSWIDTH_ADD:{	
					if(state == 0x00){
						RES(R_STANDBY_SP_KEY_POSWIDTH_ADD_DOWN);
						SET(R_STANDBY_SP_KEY_POSWIDTH_ADD_UP);
					}
					else if(state == 0x01){//DOWN
						SET(R_STANDBY_SP_KEY_POSWIDTH_ADD_DOWN);
						RES(R_STANDBY_SP_KEY_POSWIDTH_ADD_UP);
				...
				case GDDC_PAGE_STANDBY_SP_KEY_POSWIDTH_DEC:{
					if(state == 0x00){
						RES(R_STANDBY_SP_KEY_POSWIDTH_DEC_DOWN);
						SET(R_STANDBY_SP_KEY_POSWIDTH_DEC_UP);
			
					}
					else if(state == 0x01){//DOWN
						SET(R_STANDBY_SP_KEY_POSWIDTH_DEC_DOWN);
						RES(R_STANDBY_SP_KEY_POSWIDTH_DEC_UP);
				...
				case GDDC_PAGE_STANDBY_SP_KEY_ENTER_STANDBY:{
					if(state == 0x01){
						SET(R_STANDBY_KEY_ENTER_READY_DOWN);
					}
					break;
		...
		case GDDC_PAGE_STANDBY_MP:{//主界面STANDBY MP
			switch(control_id){				
				...
				case GDDC_PAGE_STANDBY_MP_KEY_POSWIDTH_ADD:{	
					if(state == 0x00){
						RES(R_STANDBY_MP_KEY_POSWIDTH_ADD_DOWN);
						SET(R_STANDBY_MP_KEY_POSWIDTH_ADD_UP);
					}
					else if(state == 0x01){//DOWN
						SET(R_STANDBY_MP_KEY_POSWIDTH_ADD_DOWN);
						RES(R_STANDBY_MP_KEY_POSWIDTH_ADD_UP);
				...
				case GDDC_PAGE_STANDBY_MP_KEY_POSWIDTH_DEC:{
					if(state == 0x00){
						RES(R_STANDBY_MP_KEY_POSWIDTH_DEC_DOWN);
						SET(R_STANDBY_MP_KEY_POSWIDTH_DEC_UP);
			
					}
					else if(state == 0x01){//DOWN
						SET(R_STANDBY_MP_KEY_POSWIDTH_DEC_DOWN);
						RES(R_STANDBY_MP_KEY_POSWIDTH_DEC_UP);
				...
				case GDDC_PAGE_STANDBY_MP_KEY_NEGWIDTH_ADD:{
					if(state == 0x00){
						RES(R_STANDBY_MP_KEY_NEGWIDTH_ADD_DOWN);
						SET(R_STANDBY_MP_KEY_NEGWIDTH_ADD_UP);
					}
					else if(state == 0x01){//DOWN
						SET(R_STANDBY_MP_KEY_NEGWIDTH_ADD_DOWN);
						RES(R_STANDBY_MP_KEY_NEGWIDTH_ADD_UP);
				...
				case GDDC_PAGE_STANDBY_MP_KEY_NEGWIDTH_DEC:{
					if(state == 0x00){
						RES(R_STANDBY_MP_KEY_NEGWIDTH_DEC_DOWN);
						SET(R_STANDBY_MP_KEY_NEGWIDTH_DEC_UP);
					}
					else if(state == 0x01){//DOWN
						SET(R_STANDBY_MP_KEY_NEGWIDTH_DEC_DOWN);
						RES(R_STANDBY_MP_KEY_NEGWIDTH_DEC_UP);
				...
				case GDDC_PAGE_STANDBY_MP_KEY_ENTER_STANDBY:{
					if(state == 0x01){
						SET(R_STANDBY_KEY_ENTER_READY_DOWN);
					}
					break;
		...
		case GDDC_PAGE_STANDBY_GP:{//主界面STANDBY GP
			switch(control_id){				
				case GDDC_PAGE_STANDBY_GP_KEY_POWER_CH0_ADD:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_GP_POWER_CH0] < CONFIG_MAX_LASERPOWER_CH0){
							ADDS1(EM_LASER_GP_POWER_CH0);
							NVRAM0[EM_TOTAL_POWER] = NVRAM0[EM_LASER_GP_POWER_CH0] + NVRAM0[EM_LASER_GP_POWER_CH1];
							SetTextFloat(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_POWER_CH0, ((fp32_t)(NVRAM0[EM_LASER_GP_POWER_CH0]) / 10), 1 , 1);		
							SetTextInt32(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_TOTAL_POWER ,NVRAM0[EM_TOTAL_POWER], 1, 0);
							SetProgressValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_PROGRESS_CH0, ((uint32_t)NVRAM0[EM_LASER_GP_POWER_CH0] * 100 / CONFIG_MAX_LASERPOWER_CH0));						
						}
					}
					break;
				}
				case GDDC_PAGE_STANDBY_GP_KEY_POWER_CH0_DEC:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_GP_POWER_CH0] > CONFIG_MIN_LASERPOWER_CH0){
							DECS1(EM_LASER_GP_POWER_CH0);
							NVRAM0[EM_TOTAL_POWER] = NVRAM0[EM_LASER_GP_POWER_CH0] + NVRAM0[EM_LASER_GP_POWER_CH1];
							SetTextFloat(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_POWER_CH0, ((fp32_t)(NVRAM0[EM_LASER_GP_POWER_CH0]) / 10), 1 , 1);
							SetTextInt32(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_TOTAL_POWER ,NVRAM0[EM_TOTAL_POWER], 1, 0);
							SetProgressValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_PROGRESS_CH0, ((uint32_t)NVRAM0[EM_LASER_GP_POWER_CH0] * 100 / CONFIG_MAX_LASERPOWER_CH0));
				...
				case GDDC_PAGE_STANDBY_GP_KEY_POWER_CH1_ADD:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_GP_POWER_CH1] < CONFIG_MAX_LASERPOWER_CH1){
							ADDS1(EM_LASER_GP_POWER_CH1);
							NVRAM0[EM_TOTAL_POWER] = NVRAM0[EM_LASER_GP_POWER_CH0] + NVRAM0[EM_LASER_GP_POWER_CH1];
							SetTextFloat(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_POWER_CH1, ((fp32_t)(NVRAM0[EM_LASER_GP_POWER_CH1]) / 10), 1 , 1);
							SetTextFloat(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_TOTAL_POWER, ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 10), 1 , 1);
							SetProgressValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_PROGRESS_CH1, ((uint32_t)NVRAM0[EM_LASER_GP_POWER_CH1] * 100 / CONFIG_MAX_LASERPOWER_CH1));
						}
					}
					break;
				}
				case GDDC_PAGE_STANDBY_GP_KEY_POWER_CH1_DEC:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_GP_POWER_CH1] > CONFIG_MIN_LASERPOWER_CH1){
							DECS1(EM_LASER_GP_POWER_CH1);
							NVRAM0[EM_TOTAL_POWER] = NVRAM0[EM_LASER_GP_POWER_CH0] + NVRAM0[EM_LASER_GP_POWER_CH1];
							SetTextFloat(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_TEXTDISPLAY_POWER_CH1, ((fp32_t)(NVRAM0[EM_LASER_GP_POWER_CH1]) / 10), 1 , 1);
							SetTextFloat(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_TEXTDISPLAY_TOTAL_POWER, ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 10), 1 , 1);
							SetProgressValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_PROGRESS_CH1, ((uint32_t)NVRAM0[EM_LASER_GP_POWER_CH1] * 100 / CONFIG_MAX_LASERPOWER_CH1));
						}
					}
					break;
				...
				case GDDC_PAGE_STANDBY_GP_KEY_POSWIDTH_ADD:{	
					if(state == 0x00){
						RES(R_STANDBY_GP_KEY_POSWIDTH_ADD_DOWN);
						SET(R_STANDBY_GP_KEY_POSWIDTH_ADD_UP);
					}
					else if(state == 0x01){//DOWN
						SET(R_STANDBY_GP_KEY_POSWIDTH_ADD_DOWN);
						RES(R_STANDBY_GP_KEY_POSWIDTH_ADD_UP);
				...
				case GDDC_PAGE_STANDBY_GP_KEY_POSWIDTH_DEC:{
					if(state == 0x00){
						RES(R_STANDBY_GP_KEY_POSWIDTH_DEC_DOWN);
						SET(R_STANDBY_GP_KEY_POSWIDTH_DEC_UP);
			
					}
					else if(state == 0x01){//DOWN
						SET(R_STANDBY_GP_KEY_POSWIDTH_DEC_DOWN);
						RES(R_STANDBY_GP_KEY_POSWIDTH_DEC_UP);
				...
				case GDDC_PAGE_STANDBY_GP_KEY_NEGWIDTH_ADD:{
					if(state == 0x00){
						RES(R_STANDBY_GP_KEY_NEGWIDTH_ADD_DOWN);
						SET(R_STANDBY_GP_KEY_NEGWIDTH_ADD_UP);
					}
					else if(state == 0x01){//DOWN
						SET(R_STANDBY_GP_KEY_NEGWIDTH_ADD_DOWN);
						RES(R_STANDBY_GP_KEY_NEGWIDTH_ADD_UP);
				...
				case GDDC_PAGE_STANDBY_GP_KEY_NEGWIDTH_DEC:{
					if(state == 0x00){
						RES(R_STANDBY_GP_KEY_NEGWIDTH_DEC_DOWN);
						SET(R_STANDBY_GP_KEY_NEGWIDTH_DEC_UP);
					}
					else if(state == 0x01){//DOWN
						SET(R_STANDBY_GP_KEY_NEGWIDTH_DEC_DOWN);
						RES(R_STANDBY_GP_KEY_NEGWIDTH_DEC_UP);
				...
				case GDDC_PAGE_STANDBY_GP_KEY_TIMES_ADD:{
					if(state == 0x00){
						RES(R_STANDBY_GP_KEY_TIMES_ADD_DOWN);
						SET(R_STANDBY_GP_KEY_TIMES_ADD_UP);
					}
					else if(state == 0x01){
						SET(R_STANDBY_GP_KEY_TIMES_ADD_DOWN);
						RES(R_STANDBY_GP_KEY_TIMES_ADD_UP);
				...
				case GDDC_PAGE_STANDBY_GP_KEY_TIMES_DEC:{
					if(state == 0x0){
						RES(R_STANDBY_GP_KEY_TIMES_DEC_DOWN);
						SET(R_STANDBY_GP_KEY_TIMES_DEC_UP);
					}
					else if(state == 0x01){
						SET(R_STANDBY_GP_KEY_TIMES_DEC_DOWN);
						RES(R_STANDBY_GP_KEY_TIMES_DEC_UP);
				...
				case GDDC_PAGE_STANDBY_GP_KEY_GROUP_OFF_ADD:{
					if(state == 0x0){
						RES(R_STANDBY_GP_KEY_GROUP_OFF_ADD_DOWN);
						SET(R_STANDBY_GP_KEY_GROUP_OFF_ADD_UP);
					}
					else if(state == 0x01){//DOWN
						SET(R_STANDBY_GP_KEY_GROUP_OFF_ADD_DOWN);
						RES(R_STANDBY_GP_KEY_GROUP_OFF_ADD_UP);
				...
				case GDDC_PAGE_STANDBY_GP_KEY_GROUP_OFF_DEC:{
					if(state == 0x0){//UP
						RES(R_STANDBY_GP_KEY_GROUP_OFF_DEC_DOWN);
						SET(R_STANDBY_GP_KEY_GROUP_OFF_DEC_UP);
					}
					else if(state == 0x01){//DOWN
						SET(R_STANDBY_GP_KEY_GROUP_OFF_DEC_DOWN);
						RES(R_STANDBY_GP_KEY_GROUP_OFF_DEC_UP);
				...
				case GDDC_PAGE_STANDBY_GP_KEY_ENTER_STANDBY:{
					if(state == 0x01){
						SET(R_STANDBY_KEY_ENTER_READY_DOWN);
					}
					break;
		...
		case GDDC_PAGE_STANDBY_SIGNAL:{//主界面STANDBY EVLA SIGNAL
			switch(control_id){				
				...
				case GDDC_PAGE_STANDBY_SIGNAL_KEY_POWER_CH0_DEC:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_POWER_CH0] > CONFIG_MIN_LASERPOWER_CH0){
							DECS1(EM_LASER_POWER_CH0);
							NVRAM0[EM_TOTAL_POWER] = NVRAM0[EM_LASER_POWER_CH0] + NVRAM0[EM_LASER_POWER_CH1];
							SetTextFloat(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_POWER_CH0, ((fp32_t)(NVRAM0[EM_LASER_GP_POWER_CH0]) / 10), 1 , 1);
							SetTextInt32(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_TOTAL_POWER ,NVRAM0[EM_TOTAL_POWER], 1, 0);
							SetProgressValue(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_PROGRESS_CH0, ((uint32_t)NVRAM0[EM_LASER_POWER_CH0] * 100 / CONFIG_MAX_LASERPOWER_CH0));
						}
					}
				...
				case GDDC_PAGE_STANDBY_SIGNAL_KEY_ENERGY_INTERVAL_ADD:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_SIGNAL_ENERGY_INTERVAL] < CONFIG_MAX_LASER_ENERGY_INTERVAL){
							...
							SetTextInt32(GDDC_PAGE_STANDBY_SIGNAL, GDDC_PAGE_STANDBY_SIGNAL_TEXTDISPLAY_ENERGY_INT , (NVRAM0[EM_LASER_SIGNAL_ENERGY_INTERVAL] * CONFIG_LASER_ENERGY_INTERVAL), 1, 0);
						}
					}
					break;
				}
				...
				case GDDC_PAGE_STANDBY_SIGNAL_KEY_STANDBY:{
					if(state == 0x01){
						SET(R_STANDBY_GP_KEY_ENTER_READY_DOWN);
					}
					break;
				}
				...
				case GDDC_PAGE_STANDBY_GP_KEY_ENTER_OPTION:{
					if(state == 0x01){
						SET(R_STANDBY_GP_KEY_OPTION_DOWN);
					}
					else if(state == 0x00){
						SET(R_STANDBY_GP_KEY_OPTION_UP);
					}
					break;
				}
				default:break;
		...
		case GDDC_PAGE_READY_CW:{//主界面READY CW
			switch(control_id){
				case GDDC_PAGE_READY_CW_KEY_READY:{
					if(state == 0x01){
		...
		case GDDC_PAGE_READY_SP:{//主界面READY SP
			switch(control_id){
				case GDDC_PAGE_READY_SP_KEY_READY:{
					if(state == 0x01){
						SET(R_READY_KEY_READY_DOWN);
					}
					break;
		...
		case GDDC_PAGE_READY_MP:{//主界面READY MP
			switch(control_id){
				case GDDC_PAGE_READY_MP_KEY_READY:{
					if(state == 0x01){
						SET(R_READY_KEY_READY_DOWN);
					}
					break;
		...
		case GDDC_PAGE_READY_GP:{////主界面READY GP
			switch(control_id){
				case GDDC_PAGE_READY_GP_KEY_READY:{
					if(state == 0x01){
						SET(R_READY_KEY_READY_DOWN);
					}
					break;
		...
		case GDDC_PAGE_READY_SIGNAL:{//主界面READY EVLA SIGNAL
			switch(control_id){
				case GDDC_PAGE_READY_SIGNAL_KEY_READY:{
					if(state == 0x01){
						SET(R_READY_KEY_READY_DOWN);
					}
					break;
		...
		case GDDC_PAGE_READY_DERMA:{////主界面READY DERMA
			switch(control_id){
				case GDDC_PAGE_READY_DERMA_KEY_READY:{
					if(state == 0x01){
						SET(R_READY_KEY_READY_DOWN);
					}
					break;
