...
void unselectSchemeNum(sel){//反选方案条
	switch(sel){
		case 0:{
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_0 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_0, 0x0);
			break;
		}
		case 1:{
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_1 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_1, 0x0);
			break;
		}
		case 2:{
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_2 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_2, 0x0);
			break;
		}
		case 3:{
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_3 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_3, 0x0);
			break;
		}
		case 4:{
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_4 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_4, 0x0);
			break;
		}
		case 5:{
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_5 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_5, 0x0);
			break;
		}
		case 6:{
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_6 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_6, 0x0);
			break;
		}
		case 7:{
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_7 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_7, 0x0);
			break;
		}
		case 8:{
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_8 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_8, 0x0);
			break;
		}
		case 9:{
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_9 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_9, 0x0);
			break;
		}
		case 10:{
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_10 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_10, 0x0);
			break;
		}
		case 11:{
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_11 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_11, 0x0);
			break;
		}
		case 12:{
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_12 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_12, 0x0);
			break;
		}
		case 13:{
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_13 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_13, 0x0);
			break;
		}
		case 14:{
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_14 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_14, 0x0);
			break;
		}
		case 15:{
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_15 ,HMI_WHITE);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_15, 0x0);
			break;
		}
		default:break;
	}
...
void seletcSchemeNum(uint16_t sel){
	switch(sel){
		case 0:{
			...
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_0 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_0, 0x1);
			NVRAM0[EM_SCHEME_NUM_TMP] = 0;
			break;
		}
		case 1:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_1 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_1, 0x1);		
			NVRAM0[EM_SCHEME_NUM_TMP] = 1;
			break;
		}
		case 2:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_2 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_2, 0x1);
			NVRAM0[EM_SCHEME_NUM_TMP] = 2;
			break;
		}
		case 3:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_3 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_3, 0x1);
			NVRAM0[EM_SCHEME_NUM_TMP] = 3;
			break;
		}
		case 4:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_4 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_4, 0x1);
			NVRAM0[EM_SCHEME_NUM_TMP] = 4;
			break;
		}
		case 5:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_5 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_5, 0x1);
			NVRAM0[EM_SCHEME_NUM_TMP] = 5;
			break;
		}
		case 6:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_6 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_6, 0x1);
			NVRAM0[EM_SCHEME_NUM_TMP] = 6;
			break;
		}
		case 7:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_7 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_7, 0x1);
			NVRAM0[EM_SCHEME_NUM_TMP] = 7;
			break;
		}
		case 8:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_8 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_8, 0x1);
			NVRAM0[EM_SCHEME_NUM_TMP] = 8;
			break;
		}
		case 9:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_9 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_9, 0x1);	
			NVRAM0[EM_SCHEME_NUM_TMP] = 9;
			break;
		}
		case 10:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_10 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_10, 0x1);
			NVRAM0[EM_SCHEME_NUM_TMP] = 10;
			break;
		}
		case 11:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_11 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_11, 0x1);	
			NVRAM0[EM_SCHEME_NUM_TMP] = 11;
			break;
		}
		case 12:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_12 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_12, 0x1);	
			NVRAM0[EM_SCHEME_NUM_TMP] = 12;
			break;
		}
		case 13:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_13 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_13, 0x1);
			NVRAM0[EM_SCHEME_NUM_TMP] = 13;
			break;
		}
		case 14:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_14 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_14, 0x1);
			NVRAM0[EM_SCHEME_NUM_TMP] = 14;
			break;
		}
		case 15:{
			unselectSchemeNum(NVRAM0[DM_SCHEME_NUM]);
			SetControlBackColor(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_TEXTDISPLAY_SCHEME_15 ,HMI_CYAN);
			SetButtonValue(GDDC_PAGE_SCHEME_A_0, GDDC_PAGE_SCHEME_KEY_SCHEME_SELECT_15, 0x1);
