	...
	switch(NVRAM0[EM_LASER_PULSE_MODE]){
		case LASER_MODE_CW:{
			...
			switch(NVRAM0[EM_LASER_SELECT]){
				case LASER_SELECT_CH0:{
					SetButtonValue(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_CW_KEY_SELECT_CH0, 0x01);
				...
				case LASER_SELECT_CH1:{
					...
					SetButtonValue(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_CW_KEY_SELECT_CH1, 0x01);
					SetButtonValue(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_CW_KEY_SELECT_BOTH, 0x00);
					break;
				}
				case LASER_SELECT_BOTH:{
					SetButtonValue(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_CW_KEY_SELECT_CH0, 0x00);
					SetButtonValue(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_CW_KEY_SELECT_CH1, 0x00);
					SetButtonValue(GDDC_PAGE_STANDBY_CW_0, GDDC_PAGE_STANDBY_CW_KEY_SELECT_BOTH, 0x01);
					break;
				}
				default:break;
			}
		...
		case LASER_MODE_SP:{
			...
			switch(NVRAM0[EM_LASER_SELECT]){
				case LASER_SELECT_CH0:{
					SetButtonValue(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_SP_KEY_SELECT_CH0, 0x01);
					SetButtonValue(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_SP_KEY_SELECT_CH1, 0x00);
					SetButtonValue(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_SP_KEY_SELECT_BOTH, 0x00);
					break;
				}
				case LASER_SELECT_CH1:{
					SetButtonValue(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_SP_KEY_SELECT_CH0, 0x00);
					SetButtonValue(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_SP_KEY_SELECT_CH1, 0x01);
					SetButtonValue(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_SP_KEY_SELECT_BOTH, 0x00);
					break;
				}
				case LASER_SELECT_BOTH:{
					SetButtonValue(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_SP_KEY_SELECT_CH0, 0x00);
					SetButtonValue(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_SP_KEY_SELECT_CH1, 0x00);
					SetButtonValue(GDDC_PAGE_STANDBY_SP_0, GDDC_PAGE_STANDBY_SP_KEY_SELECT_BOTH, 0x01);
					break;
				}
				default:break;
			}
		...
		case LASER_MODE_MP:{
			...
			switch(NVRAM0[EM_LASER_SELECT]){
				case LASER_SELECT_CH0:{
					SetButtonValue(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_MP_KEY_SELECT_CH0, 0x01);
				...
				case LASER_SELECT_CH1:{
					...
					SetButtonValue(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_MP_KEY_SELECT_CH1, 0x01);
					SetButtonValue(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_MP_KEY_SELECT_BOTH, 0x00);
					break;
				}
				case LASER_SELECT_BOTH:{
					SetButtonValue(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_MP_KEY_SELECT_CH0, 0x00);
					SetButtonValue(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_MP_KEY_SELECT_CH1, 0x00);
					SetButtonValue(GDDC_PAGE_STANDBY_MP_0, GDDC_PAGE_STANDBY_MP_KEY_SELECT_BOTH, 0x01);
					break;
				}
				default:break;
			}
		...
		case LASER_MODE_GP:{
			...
			switch(NVRAM0[EM_LASER_SELECT]){
				case LASER_SELECT_CH0:{
					SetButtonValue(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_GP_KEY_SELECT_CH0, 0x01);
				...
				case LASER_SELECT_CH1:{
					...
					SetButtonValue(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_GP_KEY_SELECT_CH1, 0x01);
					SetButtonValue(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_GP_KEY_SELECT_BOTH, 0x00);
					break;
				}
				case LASER_SELECT_BOTH:{
					SetButtonValue(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_GP_KEY_SELECT_CH0, 0x00);
					SetButtonValue(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_GP_KEY_SELECT_CH1, 0x00);
					SetButtonValue(GDDC_PAGE_STANDBY_GP_0, GDDC_PAGE_STANDBY_GP_KEY_SELECT_BOTH, 0x01);
					break;
				}
				default:break;
			}
		...
		case LASER_MODE_DERMA:{
			...
			switch(NVRAM0[EM_LASER_SELECT]){
				case LASER_SELECT_CH0:{
					SetButtonValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_KEY_SELECT_CH0, 0x01);
				...
				case LASER_SELECT_CH1:{
					...
					SetButtonValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_KEY_SELECT_CH1, 0x01);
					SetButtonValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_KEY_SELECT_BOTH, 0x00);
					break;
				}
				case LASER_SELECT_BOTH:{
					SetButtonValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_KEY_SELECT_CH0, 0x00);
					SetButtonValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_KEY_SELECT_CH1, 0x00);
					SetButtonValue(GDDC_PAGE_STANDBY_DERMA_0, GDDC_PAGE_STANDBY_DERMA_KEY_SELECT_BOTH, 0x01);
					break;
				}
				default:break;
			}
		...
		case LASER_MODE_SIGNAL:{
			...
			switch(NVRAM0[EM_LASER_SELECT]){
				case LASER_SELECT_CH0:{
					SetButtonValue(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_SIGNAL_KEY_SELECT_CH0, 0x01);
					SetButtonValue(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_SIGNAL_KEY_SELECT_CH1, 0x00);
					SetButtonValue(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_SIGNAL_KEY_SELECT_BOTH, 0x00);
					break;
				}
				case LASER_SELECT_CH1:{
					SetButtonValue(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_SIGNAL_KEY_SELECT_CH0, 0x00);
					SetButtonValue(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_SIGNAL_KEY_SELECT_CH1, 0x01);
					SetButtonValue(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_SIGNAL_KEY_SELECT_BOTH, 0x00);
					break;
				}
				case LASER_SELECT_BOTH:{
					SetButtonValue(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_SIGNAL_KEY_SELECT_CH0, 0x00);
					SetButtonValue(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_SIGNAL_KEY_SELECT_CH1, 0x00);
					SetButtonValue(GDDC_PAGE_STANDBY_SIGNAL_0, GDDC_PAGE_STANDBY_SIGNAL_KEY_SELECT_BOTH, 0x01);
					break;
				}
				default:break;
			}	
...
void dcHmiLoop(void){//HMI轮训程序
	...
	if(NVRAM0[EM_HMI_OPERA_STEP] == FSMSTEP_CHECK_EPROM){//EPROM自检步骤
		...
		epromWriteOneByte((CONFIG_EPROM_SIZE - 5), NVRAM0[TM_START + 0]);//写EPROM
		epromWriteOneByte((CONFIG_EPROM_SIZE - 6), NVRAM0[TM_START + 1]);//写EPROM
		epromWriteOneByte((CONFIG_EPROM_SIZE - 7), NVRAM0[TM_START + 2]);//写EPROM
		epromWriteOneByte((CONFIG_EPROM_SIZE - 8), NVRAM0[TM_START + 3]);//写EPROM
		//读EPROM
		NVRAM0[TM_START + 4] = epromReadOneByte((CONFIG_EPROM_SIZE - 5));
		NVRAM0[TM_START + 5] = epromReadOneByte((CONFIG_EPROM_SIZE - 6));
		NVRAM0[TM_START + 6] = epromReadOneByte((CONFIG_EPROM_SIZE - 7));
		NVRAM0[TM_START + 7] = epromReadOneByte((CONFIG_EPROM_SIZE - 8));
