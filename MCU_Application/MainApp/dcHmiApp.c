...
//	SetTextFloat(GDDC_PAGE_READY, GDDC_PAGE_READY_TEXTDISPLAY_TOTAL_POWER, ((fp32_t)(NVRAM0[EM_TOTAL_POWER]) / 10), 1 , 1);
...
static void updateStandbyDisplay(void){//更新方案显示
	...
	switch(NVRAM0[EM_LASER_PULSE_MODE]){
		case LASER_MODE_CW:{			
			...
			//SetTextFloat(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_ENERGY, ((fp32_t)(NVRAM0[EM_LASER_POWER_CH0]) / 10), 1 , 1);
			//SetTextFloat(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_RELEASE_TIME, ((fp32_t)(NVRAM0[EM_RELEASE_TOTAL_TIME_L]) / 10), 1 , 1);
			...
			SetButtonValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_MODE_EVLA_SIGNAL, 0x00);
		...
		case LASER_MODE_SP:{
			...
			SetButtonValue(GDDC_PAGE_STANDBY_SP, GDDC_PAGE_STANDBY_SP_KEY_MODE_EVLA_SIGNAL, 0x00);
		...
		case LASER_MODE_MP:{
			...
			SetButtonValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_EVLA_SIGNAL, 0x00);
		...
		case LASER_MODE_GP:{
			...
			SetButtonValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_EVLA_SIGNAL, 0x00);
		...
		case LASER_MODE_DERMA:{
			...
			SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_EVLA_SIGNAL, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_DERMA, GDDC_PAGE_STANDBY_DERMA_KEY_MODE_DERMA, 0x01);
			break;
		}
		case LASER_MODE_EVLA_SIGNAL:{
			SetButtonValue(GDDC_PAGE_STANDBY_EVLA_SIGNAL, GDDC_PAGE_STANDBY_EVLA_SIGNAL_KEY_MODE_CW, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_EVLA_SIGNAL, GDDC_PAGE_STANDBY_EVLA_SIGNAL_KEY_MODE_MP, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_EVLA_SIGNAL, GDDC_PAGE_STANDBY_EVLA_SIGNAL_KEY_MODE_GP, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_EVLA_SIGNAL, GDDC_PAGE_STANDBY_EVLA_SIGNAL_KEY_MODE_SP, 0x00);
			SetButtonValue(GDDC_PAGE_STANDBY_EVLA_SIGNAL, GDDC_PAGE_STANDBY_EVLA_SIGNAL_KEY_MODE_EVLA_SIGNAL, 0x01);
			SetButtonValue(GDDC_PAGE_STANDBY_EVLA_SIGNAL, GDDC_PAGE_STANDBY_EVLA_SIGNAL_KEY_MODE_DERMA, 0x00);
			break;
		}
		default:break;
	}
	...
	switch(screen_id){
		...
		case GDDC_PAGE_STANDBY_CW:{//主界面STANDBY CW
			switch(control_id){				
				...
				case GDDC_PAGE_STANDBY_CW_KEY_POSWIDTH_ADD:{	
					if(state == 0x00){
						RES(R_STANDBY_CW_KEY_POSWIDTH_ADD_DOWN);
						SET(R_STANDBY_CW_KEY_POSWIDTH_ADD_UP);
					}
					else if(state == 0x01){//DOWN
						SET(R_STANDBY_CW_KEY_POSWIDTH_ADD_DOWN);
						RES(R_STANDBY_CW_KEY_POSWIDTH_ADD_UP);
						if(NVRAM0[EM_LASER_POSWIDTH] < CONFIG_MAX_LASER_POSWIDTH){
							ADDS1(EM_LASER_POSWIDTH);//+1
							SetTextInt32(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_POSWIDTH ,NVRAM0[EM_LASER_CW_POSWIDTH], 1, 0);
						}
					}
					break;
				}
				case GDDC_PAGE_STANDBY_CW_KEY_POSWIDTH_DEC:{
					if(state == 0x00){
						RES(R_STANDBY_CW_KEY_POSWIDTH_DEC_DOWN);
						SET(R_STANDBY_CW_KEY_POSWIDTH_DEC_UP);
			
					}
					else if(state == 0x01){//DOWN
						SET(R_STANDBY_CW_KEY_POSWIDTH_DEC_DOWN);
						RES(R_STANDBY_CW_KEY_POSWIDTH_DEC_UP);
						if(NVRAM0[EM_LASER_CW_POSWIDTH] > CONFIG_MIN_LASER_POSWIDTH){
							DECS1(EM_LASER_CW_POSWIDTH);//-1
							SetTextInt32(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_POSWIDTH ,NVRAM0[EM_LASER_CW_POSWIDTH], 1, 0);
						}
					}
					break;
				}
				case GDDC_PAGE_STANDBY_CW_KEY_NEGWIDTH_ADD:{
					if(state == 0x00){
						RES(R_STANDBY_CW_KEY_NEGWIDTH_ADD_DOWN);
						SET(R_STANDBY_CW_KEY_NEGWIDTH_ADD_UP);
					}
					else if(state == 0x01){//DOWN
						SET(R_STANDBY_CW_KEY_NEGWIDTH_ADD_DOWN);
						RES(R_STANDBY_CW_KEY_NEGWIDTH_ADD_UP);
						if(NVRAM0[EM_LASER_CW_NEGWIDTH] < CONFIG_MAX_LASER_NEGWIDTH){
							ADDS1(EM_LASER_CW_NEGWIDTH);//+1
							SetTextInt32(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_NEGWIDTH ,NVRAM0[EM_LASER_CW_NEGWIDTH], 1, 0);
						}
					}
					break;
				}
				case GDDC_PAGE_STANDBY_CW_KEY_NEGWIDTH_DEC:{
					if(state == 0x00){
						RES(R_STANDBY_CW_KEY_NEGWIDTH_DEC_DOWN);
						SET(R_STANDBY_CW_KEY_NEGWIDTH_DEC_UP);
					}
					else if(state == 0x01){//DOWN
						SET(R_STANDBY_CW_KEY_NEGWIDTH_DEC_DOWN);
						RES(R_STANDBY_CW_KEY_NEGWIDTH_DEC_UP);
						if(NVRAM0[EM_LASER_CW_NEGWIDTH] > CONFIG_MIN_LASER_NEGWIDTH){
							SetTextInt32(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_NEGWIDTH ,NVRAM0[EM_LASER_CW_NEGWIDTH], 1, 0);
						}
					}
					break;
				}
				case GDDC_PAGE_STANDBY_CW_KEY_TIMES_ADD:{
					if(state == 0x00){
						RES(R_STANDBY_CW_KEY_TIMES_ADD_DOWN);
						SET(R_STANDBY_CW_KEY_TIMES_ADD_UP);
					}
					else if(state == 0x01){
						SET(R_STANDBY_CW_KEY_TIMES_ADD_DOWN);
						RES(R_STANDBY_CW_KEY_TIMES_ADD_UP);
						if(NVRAM0[EM_LASER_CW_TIMES] < CONFIG_MAX_LASER_TIMES){
							ADDS1(EM_LASER_CW_TIMES);//+1
							SetTextInt32(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_TIMES ,NVRAM0[EM_LASER_CW_TIMES], 1, 0);
						}
					}
					break;
				}
				case GDDC_PAGE_STANDBY_CW_KEY_TIMES_DEC:{
					if(state == 0x0){
						RES(R_STANDBY_CW_KEY_TIMES_DEC_DOWN);
						SET(R_STANDBY_CW_KEY_TIMES_DEC_UP);
					}
					else if(state == 0x01){
						SET(R_STANDBY_CW_KEY_TIMES_DEC_DOWN);
						RES(R_STANDBY_CW_KEY_TIMES_DEC_UP);
						if(NVRAM0[EM_LASER_CW_TIMES] > CONFIG_MIN_LASER_TIMES){
							DECS1(EM_LASER_CW_TIMES);//-1
							SetTextInt32(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_TIMES ,NVRAM0[EM_LASER_CW_TIMES], 1, 0);
						}	
					}
					break;
				}
				case GDDC_PAGE_STANDBY_CW_KEY_GROUP_OFF_ADD:{
					if(state == 0x0){
						RES(R_STANDBY_CW_KEY_GROUP_OFF_ADD_DOWN);
						SET(R_STANDBY_CW_KEY_GROUP_OFF_ADD_UP);
					}
					else if(state == 0x01){//DOWN
						SET(R_STANDBY_CW_KEY_GROUP_OFF_ADD_DOWN);
						RES(R_STANDBY_CW_KEY_GROUP_OFF_ADD_UP);
						if(NVRAM0[EM_LASER_CW_GROUP_OFF] < CONFIG_MAX_LASER_GROUP_OFF){
							ADDS1(EM_LASER_CW_GROUP_OFF);//+1
							SetTextInt32(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_GROUP_OFF ,NVRAM0[EM_LASER_CW_GROUP_OFF], 1, 0);
						}
					}
					break;
				}
				case GDDC_PAGE_STANDBY_CW_KEY_GROUP_OFF_DEC:{
					if(state == 0x0){//UP
						RES(R_STANDBY_CW_KEY_GROUP_OFF_DEC_DOWN);
						SET(R_STANDBY_CW_KEY_GROUP_OFF_DEC_UP);
					}
					else if(state == 0x01){//DOWN
						SET(R_STANDBY_CW_KEY_GROUP_OFF_DEC_DOWN);
						RES(R_STANDBY_CW_KEY_GROUP_OFF_DEC_UP);
						if(NVRAM0[EM_LASER_CW_GROUP_OFF] > CONFIG_MIN_LASER_GROUP_OFF){
							DECS1(EM_LASER_CW_GROUP_OFF);//-1
							SetTextInt32(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_TEXTDISPLAY_GROUP_OFF ,NVRAM0[EM_LASER_CW_GROUP_OFF], 1, 0);
						}
					}
					break;
				...
				case GDDC_PAGE_STANDBY_CW_KEY_SCHEME_DEFAULT:{//还原默认配置
					if(state == 0x01){
						defaultScheme();
						updateStandbyDisplay();
						updateReadyDisplay();
				...
				case GDDC_PAGE_STANDBY_CW_KEY_STANDBY:{
					if(state == 0x01){
						SET(R_STANDBY_CW_KEY_ENTER_READY_DOWN);
					}
					break;
				}
				...
				case GDDC_PAGE_STANDBY_CW_KEY_MODE_MP:{
					if(state == 0x01){
						...
						SetButtonValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_MODE_CW, 0x00);
						SetButtonValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_MODE_GP, 0x00);
						SetButtonValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_MODE_SP, 0x00);
						SetButtonValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_MODE_EVLA_SIGNAL, 0x00);
						SetButtonValue(GDDC_PAGE_STANDBY_CW, GDDC_PAGE_STANDBY_CW_KEY_MODE_DERMA, 0x00);
				...
				case GDDC_PAGE_STANDBY_CW_KEY_MODE_EVLA_SIGNAL:{
					if(state == 0x01){
				...
				case GDDC_PAGE_STANDBY_CW_KEY_ENTER_OPTION:{
					if(state == 0x01){
						SET(R_STANDBY_CW_KEY_OPTION_DOWN);
					}
					else if(state == 0x00){
						SET(R_STANDBY_CW_KEY_OPTION_UP);
					}
					break;
				}
				default:break;
		...
		case GDDC_PAGE_STANDBY_SP:{//主界面STANDBY SP
			switch(control_id){
				...
				case GDDC_PAGE_STANDBY_SP_KEY_MODE_EVLA_SIGNAL:{
					break;
				}
				...
				case GDDC_PAGE_STANDBY_SP_KEY_ENTER_SCHEME:{				
					break;
				}
				case GDDC_PAGE_STANDBY_SP_KEY_SCHEME_SAVE:{
					break;
				}
				case GDDC_PAGE_STANDBY_SP_KEY_SCHEME_NEXT:{
					break;
				}
				case GDDC_PAGE_STANDBY_SP_KEY_SCHEME_LAST:{
					break;
				}
		...
		case GDDC_PAGE_STANDBY_MP:{//主界面STANDBY MP
			switch(control_id){				
				...
				case GDDC_PAGE_STANDBY_MP_KEY_TIMES_ADD:{
					if(state == 0x00){
						RES(R_STANDBY_MP_KEY_TIMES_ADD_DOWN);
						SET(R_STANDBY_MP_KEY_TIMES_ADD_UP);
					}
					else if(state == 0x01){
						SET(R_STANDBY_MP_KEY_TIMES_ADD_DOWN);
						RES(R_STANDBY_MP_KEY_TIMES_ADD_UP);
						if(NVRAM0[EM_LASER_MP_TIMES] < CONFIG_MAX_LASER_TIMES){
							ADDS1(EM_LASER_MP_TIMES);//+1
							SetTextInt32(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_TEXTDISPLAY_TIMES ,NVRAM0[EM_LASER_MP_TIMES], 1, 0);
						}
					}
					break;
				}
				...
				case GDDC_PAGE_STANDBY_MP_KEY_STANDBY:{
					if(state == 0x01){
						SET(R_STANDBY_MP_KEY_ENTER_READY_DOWN);
					}
					break;
				}
				...
				case GDDC_PAGE_STANDBY_MP_KEY_MODE_CW:{
					if(state == 0x01){
						NVRAM0[EM_LASER_PULSE_MODE] = LASER_MODE_CW;
						SetButtonValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_MP, 0x00);
						SetButtonValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_GP, 0x00);
						SetButtonValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_SP, 0x00);
						SetButtonValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_EVLA_SIGNAL, 0x00);
						SetButtonValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_DERMA, 0x00);
				...
				case GDDC_PAGE_STANDBY_MP_KEY_MODE_EVLA_SIGNAL:{
					if(state == 0x01){
						NVRAM0[EM_LASER_PULSE_MODE] = LASER_MODE_EVLA_SIGNAL;
						SetButtonValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_CW, 0x00);
						SetButtonValue(GDDC_PAGE_STANDBY_MP, GDDC_PAGE_STANDBY_MP_KEY_MODE_MP, 0x00);
				...
				case GDDC_PAGE_STANDBY_MP_KEY_ENTER_OPTION:{
					if(state == 0x01){
						SET(R_STANDBY_MP_KEY_OPTION_DOWN);
					}
					else if(state == 0x00){
						SET(R_STANDBY_MP_KEY_OPTION_UP);
					}
					break;
				}
				default:break;
		...
		case GDDC_PAGE_STANDBY_GP:{//主界面STANDBY GP
			switch(control_id){				
				...
				case GDDC_PAGE_STANDBY_GP_KEY_SCHEME_DEFAULT:{//还原默认配置
					if(state == 0x01){
						defaultScheme();
						updateStandbyDisplay();
						updateReadyDisplay();
				...
				case GDDC_PAGE_STANDBY_GP_KEY_MODE_CW:{
					if(state == 0x01){
						NVRAM0[EM_LASER_PULSE_MODE] = LASER_MODE_CW;
						SetButtonValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_MP, 0x00);
						SetButtonValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_GP, 0x00);
						SetButtonValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_SP, 0x00);
						SetButtonValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_EVLA_SIGNAL, 0x00);
						SetButtonValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_DERMA, 0x00);
					}
				...
				case GDDC_PAGE_STANDBY_GP_KEY_MODE_EVLA_SIGNAL:{
					if(state == 0x01){
						NVRAM0[EM_LASER_PULSE_MODE] = LASER_MODE_EVLA_SIGNAL;
						SetButtonValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_CW, 0x00);
						SetButtonValue(GDDC_PAGE_STANDBY_GP, GDDC_PAGE_STANDBY_GP_KEY_MODE_MP, 0x00);
		...
		case GDDC_PAGE_STANDBY_GP_EVLA_SIGNAL:{//主界面STANDBY EVLA SIGNAL
			switch(control_id){				
				case GDDC_PAGE_STANDBY_EVLA_SIGNAL_KEY_POWER_CH0_ADD:{
					if(state == 0x01){
						if(NVRAM0[EM_LASER_POWER_CH0] < CONFIG_MAX_LASERPOWER_CH0){
							ADDS1(EM_LASER_POWER_CH0);
							NVRAM0[EM_TOTAL_POWER] = NVRAM0[EM_LASER_POWER_CH0] + NVRAM0[EM_LASER_POWER_CH1];
		...
		case GDDC_PAGE_READY_EVLA_SIGNAL:{//主界面READY EVLA SIGNAL
			break;
		}
