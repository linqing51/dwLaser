...
#define EM_LASER_TIMES							(EM_START + 23)//脉冲数
#define EM_LASER_GROUP_OFF						(EM_START + 24)//脉冲间隔
...
#define EM_TOTAL_POWER							(EM_START + 61)//设定总功率				709
#define EM_RELEASE_TOTAL_TIME					(EM_START + 62)//发射总时间				710
#define EM_RELEASE_TOTAL_ENERGY					(EM_START + 64)//发射总能量				712
...
#define DM_LASER_TIMES							(DM_START +  23)//脉冲数				95
#define DM_LASER_GROUP_OFF							(DM_START +  24)//脉冲间隔				96
...
#define R_STANDBY_KEY_POSWIDTH_DEC_DOWN			(R_START * 16 + 162)
#define R_STANDBY_KEY_POSWIDTH_DEC_UP			(R_START * 16 + 163)

#define R_STANDBY_KEY_NEGWIDTH_ADD_DOWN			(R_START * 16 + 164)
#define R_STANDBY_KEY_NEGWIDTH_ADD_UP			(R_START * 16 + 165)

#define R_STANDBY_KEY_NEGWIDTH_DEC_DOWN			(R_START * 16 + 166)
#define R_STANDBY_KEY_NEGWIDTH_DEC_UP			(R_START * 16 + 167)

#define R_STANDBY_KEY_TIMES_ADD_DOWN			(R_START * 16 + 168)
#define R_STANDBY_KEY_TIMES_ADD_UP				(R_START * 16 + 169)

#define R_STANDBY_KEY_TIMES_DEC_DOWN			(R_START * 16 + 170)
#define R_STANDBY_KEY_TIMES_DEC_UP				(R_START * 16 + 171)

#define R_STANDBY_KEY_GROUP_OFF_ADD_DOWN			(R_START * 16 + 172)
#define R_STANDBY_KEY_GROUP_OFF_ADD_UP				(R_START * 16 + 173)

#define R_STANDBY_KEY_GROUP_OFF_DEC_DOWN			(R_START * 16 + 174)
#define R_STANDBY_KEY_GROUP_OFF_DEC_UP				(R_START * 16 + 175)

#define R_STANDBY_KEY_POWER_CH0_ADD_DOWN		(R_START * 16 + 176)
#define R_STANDBY_KEY_POWER_CH0_ADD_UP			(R_START * 16 + 177)

#define R_STANDBY_KEY_POWER_CH0_DEC_DOWN		(R_START * 16 + 178)
#define R_STANDBY_KEY_POWER_CH0_DEC_UP			(R_START * 16 + 179)

#define R_STANDBY_KEY_POWER_CH1_ADD_DOWN		(R_START * 16 + 180)
#define R_STANDBY_KEY_POWER_CH1_ADD_UP			(R_START * 16 + 181)

#define R_STANDBY_KEY_POWER_CH1_DEC_DOWN		(R_START * 16 + 182)
#define R_STANDBY_KEY_POWER_CH1_DEC_UP			(R_START * 16 + 183)

#define R_STANDBY_KEY_ENTER_READY_DOWN			(R_START * 16 + 183)
#define R_STANDBY_KEY_ENTER_READY_UP			(R_START * 16 + 184)

#define R_STANDBY_KEY_ENERGY_RESET_DOWN			(R_START * 16 + 185)
#define R_STANDBY_KEY_ENERGY_RESET_UP			(R_START * 16 + 186)

#define R_STANDBY_KEY_SELECT_CH0_DOWN			(R_START * 16 + 187)
#define R_STANDBY_KEY_SELECT_CH0_UP				(R_START * 16 + 188)

#define R_STANDBY_KEY_SELECT_CH1_DOWN			(R_START * 16 + 189)
#define R_STANDBY_KEY_SELECT_CH1_UP				(R_START * 16 + 190)
	
#define R_STANDBY_KEY_SELECT_BOTH_DOWN			(R_START * 16 + 191)
#define R_STANDBY_KEY_SELECT_BOTH_UP			(R_START * 16 + 192)

#define R_STANDB_KEY_MODE_CW_DOWN				(R_START * 16 + 193)
#define R_STANDB_KEY_MODE_CW_UP					(R_START * 16 + 194)

#define R_STANDBY_KEY_MODE_MP_DOWN				(R_START * 16 + 195)
#define R_STANDBY_KEY_MODE_MP_UP				(R_START * 16 + 196)

#define R_STANDBY_KEY_MODE_GP_DOWN				(R_START * 16 + 197)
#define R_STANDBY_KEY_MODE_GP_UP				(R_START * 16 + 198)

#define R_STANDBY_KEY_MODE_EVLA_SEGMENT_DOWN	(R_START * 16 + 199)
#define R_STANDBY_KEY_MODE_EVLA_SEGMENT_UP		(R_START * 16 + 200)

#define R_STANDBY_KEY_MODE_EVLA_SIGNAL_DOWN		(R_START * 16 + 201)
#define R_STANDBY_KEY_MODE_EVLA_SIGNAL_UP		(R_START * 16 + 202)

#define R_STANDBY_KEY_MODE_DERMA_DOWN			(R_START * 16 + 203)
#define R_STANDBY_KEY_MODE_DERMA_UP				(R_START * 16 + 204)

#define R_STANDBY_KEY_OPTION_DOWN				(R_START * 16 + 205)
#define R_STANDBY_KEY_OPTION_UP					(R_START * 16 + 206)
/*****************************************************************************/
