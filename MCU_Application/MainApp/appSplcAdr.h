...
#define R_STANDBY_KEY_GROUP_ADD_DOWN			(R_START * 16 + 168)
#define R_STANDBY_KEY_GROUP_ADD_UP				(R_START * 16 + 169)

#define R_STANDBY_KEY_GROUP_DEC_DOWN			(R_START * 16 + 170)
#define R_STANDBY_KEY_GROUP_DEC_UP				(R_START * 16 + 171)

#define R_STANDBY_KEY_SPACE_ADD_DOWN			(R_START * 16 + 172)
#define R_STANDBY_KEY_SPACE_ADD_UP				(R_START * 16 + 173)

#define R_STANDBY_KEY_SPACE_DEC_DOWN			(R_START * 16 + 174)
#define R_STANDBY_KEY_SPACE_DEC_UP				(R_START * 16 + 175)
