...
#define R_STANDBY_KEY_ENTER_READY_DOWN			(R_START * 16 + 173)
#define R_STANDBY_KEY_ENTER_READY_UP			(R_START * 16 + 174)
...
#define R_SCHEME_TEXTDISPLAY_SCHEME_1_DOWN		(R_START * 16 + 251)
#define R_SCHEME_TEXTDISPLAY_SCHEME_1_UP		(R_START * 16 + 252)

#define R_SCHEME_TEXTDISPLAY_SCHEME_2_DOWN		(R_START * 16 + 253)
#define R_SCHEME_TEXTDISPLAY_SCHEME_2_UP		(R_START * 16 + 254)

#define R_SCHEME_TEXTDISPLAY_SCHEME_3_DOWN		(R_START * 16 + 255)
#define R_SCHEME_TEXTDISPLAY_SCHEME_3_UP		(R_START * 16 + 256)

#define R_SCHEME_TEXTDISPLAY_SCHEME_4_DOWN		(R_START * 16 + 257)
#define R_SCHEME_TEXTDISPLAY_SCHEME_4_UP		(R_START * 16 + 258)

#define R_SCHEME_TEXTDISPLAY_SCHEME_5_DOWN		(R_START * 16 + 259)
#define R_SCHEME_TEXTDISPLAY_SCHEME_5_UP		(R_START * 16 + 260)

#define R_SCHEME_TEXTDISPLAY_SCHEME_6_DOWN		(R_START * 16 + 261)
#define R_SCHEME_TEXTDISPLAY_SCHEME_6_UP		(R_START * 16 + 262)

#define R_SCHEME_TEXTDISPLAY_SCHEME_7_DOWN		(R_START * 16 + 263)
#define R_SCHEME_TEXTDISPLAY_SCHEME_7_UP		(R_START * 16 + 264)

#define R_SCHEME_TEXTDISPLAY_SCHEME_8_DOWN		(R_START * 16 + 265)
#define R_SCHEME_TEXTDISPLAY_SCHEME_8_UP		(R_START * 16 + 266)

#define R_SCHEME_TEXTDISPLAY_SCHEME_9_DOWN		(R_START * 16 + 267)
#define R_SCHEME_TEXTDISPLAY_SCHEME_9_UP		(R_START * 16 + 268)

#define R_SCHEME_TEXTDISPLAY_SCHEME_10_DOWN		(R_START * 16 + 269)
#define R_SCHEME_TEXTDISPLAY_SCHEME_10_UP		(R_START * 16 + 270)

#define R_SCHEME_TEXTDISPLAY_SCHEME_11_DOWN		(R_START * 16 + 271)
#define R_SCHEME_TEXTDISPLAY_SCHEME_11_UP		(R_START * 16 + 272)

#define R_SCHEME_TEXTDISPLAY_SCHEME_12_DOWN		(R_START * 16 + 273)
#define R_SCHEME_TEXTDISPLAY_SCHEME_12_UP		(R_START * 16 + 274)

#define R_SCHEME_TEXTDISPLAY_SCHEME_13_DOWN		(R_START * 16 + 275)
#define R_SCHEME_TEXTDISPLAY_SCHEME_13_UP		(R_START * 16 + 276)

#define R_SCHEME_TEXTDISPLAY_SCHEME_14_DOWN		(R_START * 16 + 277)
#define R_SCHEME_TEXTDISPLAY_SCHEME_14_UP		(R_START * 16 + 278)

#define R_SCHEME_TEXTDISPLAY_SCHEME_15_DOWN		(R_START * 16 + 279)
#define R_SCHEME_TEXTDISPLAY_SCHEME_15_UP		(R_START * 16 + 280)

#define R_SCHEME_TEXTDISPLAY_POSWIDTH_DOWN		(R_START * 16 + 281)
#define R_SCHEME_TEXTDISPLAY_POSWIDTH_UP		(R_START * 16 + 282)

#define R_SCHEME_TEXTDISPLAY_NEGWIDTH_DOWN		(R_START * 16 + 283)
#define R_SCHEME_TEXTDISPLAY_NEGWIDTH_UP		(R_START * 16 + 284)

#define R_SCHEME_TEXTDISPLAY_GROUP_DOWN			(R_START * 16 + 285)
#define R_SCHEME_TEXTDISPLAY_GROUP_UP			(R_START * 16 + 286)
