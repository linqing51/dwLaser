...
#define R_STANDBY_KEY_READY_DOWN				(R_START * 16 + 175)
#define R_STANDBY_KEY_READY_UP					(R_START * 16 + 176)

#define R_STANDBY_KEY_ENERGY_RESET_DOWN			(R_START * 16 + 177)
#define R_STANDBY_KEY_ENERGY_RESET_UP			(R_START * 16 + 178)

#define R_STANDBY_KEY_SELECT_CH0_DOWN			(R_START * 16 + 179)
#define R_STANDBY_KEY_SELECT_CH0_UP				(R_START * 16 + 180)

#define R_STANDBY_KEY_SELECT_CH1_DOWN			(R_START * 16 + 181)
#define R_STANDBY_KEY_SELECT_CH1_UP				(R_START * 16 + 182)
	
#define R_STANDBY_KEY_SELECT_BOTH_DOWN			(R_START * 16 + 183)
#define R_STANDBY_KEY_SELECT_BOTH_UP			(R_START * 16 + 184)

#define R_STANDB_KEY_MODE_CW_DOWN				(R_START * 16 + 185)
#define R_STANDB_KEY_MODE_CW_UP					(R_START * 16 + 186)

#define R_STANDBY_KEY_MODE_MP_DOWN				(R_START * 16 + 187)
#define R_STANDBY_KEY_MODE_MP_UP				(R_START * 16 + 188)

#define R_STANDBY_KEY_MODE_GP_DOWN				(R_START * 16 + 189)
#define R_STANDBY_KEY_MODE_GP_UP				(R_START * 16 + 190)

#define R_STANDBY_KEY_MODE_EVLA_SEGMENT_DOWN	(R_START * 16 + 191)
#define R_STANDBY_KEY_MODE_EVLA_SEGMENT_UP		(R_START * 16 + 192)

#define R_STANDBY_KEY_MODE_EVLA_SIGNAL_DOWN		(R_START * 16 + 193)
#define R_STANDBY_KEY_MODE_EVLA_SIGNAL_UP		(R_START * 16 + 194)
