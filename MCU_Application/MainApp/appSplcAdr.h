...
#define R_CHECK_LDR_PASS						(R_START * 16 + 128)//激光驱动器自检通过
...
#define R_CHECK_LDR_FAIL						(R_START * 16 + 148)//激光驱动器自检失败
...
/*****************************************************************************/
#define R_READY_KEY_READY_DOWN					(R_START * 16 + 195)
#define R_READY_KEY_READY_UP					(R_START * 16 + 196)
/*****************************************************************************/
