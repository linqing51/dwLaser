...
#define EM_LASER_EVLA_SIGNAL_ENERGY_INTERVAL	(EM_START + 26)//EVLA_SIGNAL能量间隔
...
#define DM_LASER_EVLA_SIGNAL_ENERGY_INTERVAL	(EM_START +  26)//EVLA_SIGNAL能量间隔
...
/*****************************************************************************/
#define R_STANDBY_SP_KEY_POSWIDTH_ADD_DOWN						(R_START * 16 + 160)
#define R_STANDBY_SP_KEY_POSWIDTH_ADD_UP						(R_START * 16 + 161)
#define R_STANDBY_MP_KEY_POSWIDTH_ADD_DOWN						(R_START * 16 + 162)
#define R_STANDBY_MP_KEY_POSWIDTH_ADD_UP						(R_START * 16 + 163)
#define R_STANDBY_GP_KEY_POSWIDTH_ADD_DOWN						(R_START * 16 + 164)
#define R_STANDBY_GP_KEY_POSWIDTH_ADD_UP						(R_START * 16 + 165)
#define R_STANDBY_DERMA_KEY_POSWIDTH_ADD_DOWN					(R_START * 16 + 166)
#define R_STANDBY_DERMA_KEY_POSWIDTH_ADD_UP						(R_START * 16 + 167)

#define R_STANDBY_SP_KEY_POSWIDTH_DEC_DOWN						(R_START * 16 + 168)
#define R_STANDBY_SP_KEY_POSWIDTH_DEC_UP						(R_START * 16 + 169)
#define R_STANDBY_MP_KEY_POSWIDTH_DEC_DOWN						(R_START * 16 + 170)
#define R_STANDBY_MP_KEY_POSWIDTH_DEC_UP						(R_START * 16 + 171)
#define R_STANDBY_GP_KEY_POSWIDTH_DEC_DOWN						(R_START * 16 + 172)
#define R_STANDBY_GP_KEY_POSWIDTH_DEC_UP						(R_START * 16 + 173)
#define R_STANDBY_DERMA_KEY_POSWIDTH_DEC_DOWN					(R_START * 16 + 174)
#define R_STANDBY_DERMA_KEY_POSWIDTH_DEC_UP						(R_START * 16 + 175)

#define R_STANDBY_MP_KEY_NEGWIDTH_ADD_DOWN						(R_START * 16 + 176)
#define R_STANDBY_MP_KEY_NEGWIDTH_ADD_UP						(R_START * 16 + 177)
#define R_STANDBY_GP_KEY_NEGWIDTH_ADD_DOWN						(R_START * 16 + 178)
#define R_STANDBY_GP_KEY_NEGWIDTH_ADD_UP						(R_START * 16 + 179)

#define R_STANDBY_GP_KEY_TIMES_ADD_DOWN							(R_START * 16 + 180)
#define R_STANDBY_GP_KEY_TIMES_ADD_UP							(R_START * 16 + 181)

#define R_STANDBY_GP_KEY_TIMES_DEC_DOWN							(R_START * 16 + 182)
#define R_STANDBY_GP_KEY_TIMES_DEC_UP							(R_START * 16 + 183)

#define R_STANDBY_GP_KEY_GROUP_OFF_ADD_DOWN						(R_START * 16 + 184)
#define R_STANDBY_GP_KEY_GROUP_OFF_ADD_UP						(R_START * 16 + 185)

#define R_STANDBY_GP_KEY_GROUP_OFF_DEC_DOWN						(R_START * 16 + 186)
#define R_STANDBY_GP_KEY_GROUP_OFF_DEC_UP						(R_START * 16 + 187)

#define R_STANDBY_EVLA_SIGNAL_ENERGY_INTERVAL_ADD_DOWN			(R_START * 16 + 188)
#define R_STANDBY_EVLA_SIGNAL_ENERGY_INTERVAL_ADD_UP			(R_START * 16 + 189)

#define R_STANDBY_EVLA_SIGNAL_ENERGY_INTERVAL_DEC_DOWN			(R_START * 16 + 190)
#define R_STANDBY_EVLA_SIGNAL_ENERGY_INTERVAL_DEC_UP			(R_START * 16 + 191)

#define R_STANDBY_DERMA_KEY_SPOT_0MM5_DOWN						(R_START * 16 + 192)
#define R_STANDBY_DERMA_KEY_SPOT_0MM5_UP						(R_START * 16 + 193)

#define R_STANDBY_DERMA_KEY_SPOT_1MM0_DOWN						(R_START * 16 + 194)
#define R_STANDBY_DERMA_KEY_SPOT_1MM0_UP						(R_START * 16 + 195)
	
#define R_STANDBY_DERMA_KEY_SPOT_2MM0_DOWN						(R_START * 16 + 196)
#define R_STANDBY_DERMA_KEY_SPOT_2MM0_UP						(R_START * 16 + 197)

#define R_STANDBY_DERMA_KEY_SPOT_3MM0_DOWN						(R_START * 16 + 198)
#define R_STANDBY_DERMA_KEY_SPOT_3MM0_UP						(R_START * 16 + 199)
...
#define R_STANDBY_KEY_MODE_EVLA_SIGNAL_DOWN						(R_START * 16 + 226)
#define R_STANDBY_KEY_MODE_EVLA_SIGNAL_UP						(R_START * 16 + 227)
