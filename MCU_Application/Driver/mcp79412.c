// File Name    : c_i2c_rtcc_pic24fj128ga010_elwatch_b04.c 
// PIC24 family, C language. 
// Dependencies : p24fj128ga010.h, i2c.h, i2c_rtcc.h. lcd.h, delay.h 
...
*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
*
* Alexandru Valeanu	    2012.01.10.    Released for PIC24FJ128GA010 + MC79410
*
 ********************************************************************************************/
//          HARDWARE SCHEMATIC: (I2C RTCC = MCP79410) + EXPLORER 16 EVB 
//............................................................................................ 
...
// _|_   |              RD4  |--->|E     LCD        |
//       |              RD5  |--->|R/W              | 
//       |  PIC24FJ128GA010  |    |_________________|
//       |                   |     _______________
//   _--_|          RG3/SDA1 |<-->|SDA RTCC  Vbat |__     S3 = MENU KEY            
//  | S6 |RD7  I2C  RG2/SCL1 |--->|SCL MCP79410   | _|_   S6 = INCR KEY
// _|_   |          RE8/INT1 |<---|MFP            | --- BAT 
//       |___________________|    |_______________| _|_   (SDA/SCL have pull-ups) 
//                                                        (S3 /S6  have pull-ups)          
 
//¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬
//    APPLICATION'S  DESCRIPTION - ELECTRONIC WATCH BASED ON THE I2C RTCC = MCP79410  
//............................................................................................
// The firmware creates a list of drivers usefull to interface the Explorer 16 (PIC24)
// board with the MCP79410 I2C RTCC. 
// The presented drivers are: 
// - LCD 		  - keyboard (KEYB_MENU + KEYB_INCR) 
// - I2C basic    - I2C RTCC  - delay drivers 
// Moreover, the application displays on the LCD all 6 time/date variables: year, month, date,
// hour, minutes, seconds, using interrupts generated by MFP, which is connected to INT1/RE8.
// The main function performs the setup of the above variables, using the 2 onboard push-buttons:
// S3 = MENU KEY ; S6 = INCREMENT KEY.
// The setup menu is entered through the MENU KEY, which stops interrupts. Every action on the
// MENU KEY shifts the setup to the next variable. The LCD cursor points to the variable that
// must be set. 
// Every action of INCR KEY will increment the related variable. 
// Once the menu is exit(after 'seconds'), interrupts are again enabled and the RTCC counts again.    
//..................................................................................................................
//                               GLOBAL CONSTANTS
//..................................................................................................................
#define KEYB1     PORTDbits.RD6        // RD6 = MENU_KEY
#define KEYB2     PORTDbits.RD7        // RD7 = INCR_KEY  
#define KEYB_MENU 1                    // START Key has the value '1' 
#define KEYB_INCR 2                    // STOP  Key has the value '2' 
//..............................................................................................................
...
//***********************************************************************************************
//          INTERRUPT SERVICE ROUTINE: EXTERNAL INTR INT1 = MFP
//...............................................................................................
 void __attribute__((interrupt,auto_psv))_INT1Interrupt(void)
 {                                    // INT1 external interrupt generated by MFP(I2C_RTCC)
     err_flg=0                    ;   // clear the error flag 
     LATA = 0x00                  ;   // clear the breakpoint on LEDs. 
     display_time()               ;   // read from RTCC & display on LCD the time/date variables 
     IFS1bits.INT1IF  =  0     ;  }   // before exit, clear the INT1 IF    
