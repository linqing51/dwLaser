...
#line 1 "App\MainApp.c" /0
  
#line 1 "App\MainApp.h" /0
...
#line 4 "App\MainApp.h" /0
 ...
 typedef struct
 { 
 int16_t	LaserCurrent[2]; 
 int16_t PhotoDiode[2]; 
 int16_t LaserMode; 
 int16_t PosWidth; 
 int16_t NegWidth; 
 int16_t GroupNum; 
 int16_t GroupSpace; 
 int16_t SelectChannel; 
 int16_t AimVoltage; 
 int16_t FanVoltage; 
 int16_t LaserTemp; 
 int16_t RadiatorTemp; 
 int16_t EnviTemp; 
 int16_t BeemVolume; 
...
#line 1 "App\MainApp.c" /0
 ...
 OSTaskCreate(softPlcTask, (void *)0, (void *)&softPlcTaskStk[0], 5); 
 OSStart();                         
