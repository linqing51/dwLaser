...
//#endif
//		//数字滤波扫描输入IO
//		if(sTimer[STIMER_1MS_INPUT_FILTER].status)
//		{
...
//			else
//				my.footSwitch = 0;
//			my.safeInterlock = (P6 >> INPUT_INTERLOCK) & 0x01;
//			my.safeFiberDetect0 = (P6 >> INPUT_FIBERDETECT0) & 0x01;
//			my.safeFiberDetect1 = (P6 >> INPUT_FIBERDETECT1) & 0x01;
//			sTimerCtrl(STIMER_OFF, STIMER_1MS_INPUT_FILTER, CONFIG_INPUT_FILTER_TIME);//T0 STOP
//		}
//		else
//		{
//			sTimerCtrl(STIMER_ON, STIMER_1MS_INPUT_FILTER, CONFIG_INPUT_FILTER_TIME);//T0 STOP
//		}
//		//
